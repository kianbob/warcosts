...
const PAGES = [
  { href: '/spending', title: 'Military Spending', desc: 'Annual US defense budget data 1940–2024' },
  { href: '/casualties', title: 'Casualty Data', desc: 'Deaths by conflict — US military and civilian' },
  { href: '/bases', title: 'Overseas Bases', desc: '750 bases in 80 countries — the empire of bases' },
  { href: '/presidents', title: 'Presidents at War', desc: 'War scorecard by president — costs and deaths' },
  { href: '/contractors', title: 'Defense Contractors', desc: 'Who profits from war — Lockheed, Raytheon, Boeing' },
  { href: '/arms-sales', title: 'Arms Sales', desc: 'US weapons exports to 35+ countries' },
  { href: '/timeline', title: 'Timeline', desc: '1775 to present — every US military conflict' },
  { href: '/war-clock', title: 'War Clock', desc: 'Real-time military spending counter' },
  { href: '/tools/tax-receipt', title: 'Tax Receipt Calculator', desc: 'Your personal military tax burden' },
  { href: '/tools/jobs-calculator', title: 'Jobs Calculator', desc: 'Military vs civilian job creation per dollar' },
  { href: '/tools/cost-calculator', title: 'Cost Calculator', desc: 'State-by-state war cost breakdown' },
  { href: '/opportunity-cost', title: 'Opportunity Cost', desc: 'What else could $8 trillion buy?' },
  { href: '/downloads', title: 'Downloads & Data', desc: 'Download 40+ datasets: wars, spending, bases, arms, veterans' },
  { href: '/dashboard', title: 'Dashboard', desc: 'Overview of all data and key metrics' },
  { href: '/faq', title: 'FAQ', desc: 'Frequently asked questions about data, methodology, and sources' },
  { href: '/glossary', title: 'Military Glossary', desc: 'AUMF, CENTCOM, COIN, JSOC, MIC — decode military acronyms' },
  { href: '/methodology', title: 'Methodology', desc: 'How we calculate war costs and adjust for inflation' },
  { href: '/sources', title: 'Sources', desc: 'Brown University, CRS, SIPRI, DoD, OMB — our data sources' },
  { href: '/about', title: 'About WarCosts', desc: 'Mission, perspective, and TheDataProject.ai' },
  { href: '/countries', title: 'Country Profiles', desc: '167 countries — US military relationships, aid, bases, interventions' },
  { href: '/weapons', title: 'Weapons Systems', desc: '52 weapons: F-35, Tomahawk, B-2, JASSM, aircraft carriers' },
  { href: '/veterans', title: 'Veterans', desc: 'VA budget, PTSD, suicide rates, benefits, GI Bill' },
  { href: '/sanctions', title: 'Sanctions', desc: 'US economic sanctions programs and effectiveness' },
  { href: '/drone-strikes', title: 'Drone Strikes', desc: 'Obama 563 strikes vs Bush 57 — drone warfare data' },
]
