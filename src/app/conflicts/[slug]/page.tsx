        ...
        <div className="bg-slate-900 text-white rounded-xl p-8 mb-8 border border-slate-700 shadow-2xl">
          <div className="flex flex-wrap items-center gap-3 mb-4">
            ...
            <span className={`text-xs px-3 py-1 rounded-full font-medium ${
              ...
              c.outcome?.includes('Defeat') ? 'bg-red-600/20 text-red-700 border border-red-600/30' :
              c.outcome?.includes('Ongoing') || c.outcome?.includes('Developing') ? 'bg-orange-600/20 text-orange-400 border border-orange-600/30' :
              'bg-yellow-600/20 text-amber-600 border border-yellow-600/30'
            ...
            {!c.congressionalAuth && (
              <span className="text-xs px-3 py-1 rounded-full bg-red-600/20 text-red-700 border border-red-600/30">⚖️ Unconstitutional</span>
            )}
          </div>
