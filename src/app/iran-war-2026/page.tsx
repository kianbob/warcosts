...
const timeline = [
  ...
  { date: 'Apr 14', event: 'Day 46 — BLOCKADE DAY 1: No enforcement incidents. 3 Iran-linked tankers transit Hormuz to non-Iranian ports. Oil falls to $97.66/bbl on hopes of resumed talks. Reuters: both sides could return to Islamabad by week\'s end. Trump: talks could resume "over next two days." IMF cuts global growth, warns of recession if oil stays above $100. IEA: steepest quarterly oil demand decline since COVID. Italy suspends Israel defense pact — first major European ally. France-UK summit Friday on Hormuz shipping plan. Israel-Lebanon direct talks in Washington (Rubio attending). Hezbollah urges Lebanon to pull out. IDF: 100+ Hezbollah killed near Bint Jbeil in past week. China threatens "countermeasures" over tariff threats. UK Chancellor Reeves: "very frustrated and angry" at US. First humanitarian aid reaches Iran overland. Ceasefire holding — 1 week left.' },
]
