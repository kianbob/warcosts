...
const timeline = [
  ...
  { date: 'Apr 25', event: 'Day 57 — ARAGHCHI MEETS PAKISTAN PM — DENIES DIRECT US TALKS — TEHRAN FLIGHTS RESUME — ISRAEL KILLS 4+ IN LEBANON: Iran FM Araghchi meets Pakistan PM Sharif and Army Chief Munir for ~20 hours of talks in Islamabad — lays out Iran\'s demands, denies direct talks with US, departs for Oman (CBS/Reuters). Witkoff/Kushner heading to Islamabad. Tehran commercial flights resume for first time since war began — Istanbul, Muscat, Medina (Iran state TV). Pezeshkian urges electricity conservation. 4 killed in Israeli strikes on south Lebanon despite ceasefire (NNA). 2 projectiles from Lebanon toward Israel (1 intercepted). UK/Finland condemn killing of journalist Khalil. CENTCOM: 34 ships turned back. Oil ~$105. HRANA: 1,701 civilians unchanged. Lebanon: 2,454 killed. US: 15 KIA, 538 wounded.' },
  ...
  { date: 'Apr 26', event: 'Day 58 — PAKISTAN TALKS STALL — LEBANON TOLL RISES: Araghchi makes 5-hour Islamabad stopover, meets Pakistan Army Chief Munir, departs for Russia. No face-to-face with US envoys. Speaks with French FM and Qatari PM — Qatar: "sea lanes must not be used as bargaining chip." Lebanon: 2,509 killed, 7,755 wounded (health ministry update). Israel-Hezbollah trade ceasefire violation accusations — 1 Israeli soldier killed. Chevron CEO: Hormuz impacts "will be with us for some time." Only 5 ships through Hormuz in 24 hours. Oil: WTI $96.50, Brent $107.75.' },
  { date: 'Apr 27', event: 'Day 59 — IRAN OFFERS HORMUZ-FOR-PEACE — ARAGHCHI MEETS PUTIN — $5B BASE DAMAGE — UN REJECTS TOLLS: Iran proposes to reopen Hormuz if US lifts blockade and ends war — nuclear talks postponed to later date (AP, 2 regional officials). Trump unlikely to accept. Araghchi meets Putin in St. Petersburg — Russia pledges "everything possible" for peace. Germany\'s Merz: US had "no strategy" — "an entire nation is being humiliated by the Iranian leadership." UN IMO: "no legal basis" for Hormuz tolls. Benzinga: $5B damage to US bases. US troops face food shortages (USA Today). Israel kills 6 in Lebanon despite ceasefire (Yohmor al-Shaqeef, Safad al-Battikh). Brent ~$108. Lebanon: 2,509 killed. US: 15 KIA, 538 wounded.' },
  { date: 'Apr 28', event: 'Day 60 — TRUMP: IRAN IN "STATE OF COLLAPSE" — UAE QUITS OPEC — GCC SUMMIT — RUBIO COLD ON DEAL: Trump claims Iran "just informed us they are in a State of Collapse" and wants Hormuz opened — unconfirmed (AP/Reuters/Axios). Trump "not happy" with Iran\'s Hormuz-for-peace proposal. Rubio: "better than expected" but nuclear issue can\'t be postponed (NPR/Al Jazeera). UAE QUITS OPEC effective May 1 (Reuters/Bloomberg/CNN) — massive blow. GCC emergency summit in Jeddah chaired by MBS — first since Gulf states became war front (Reuters). Bessent: Iran pumping "will soon collapse" under blockade. Iran bans steel exports (Fars). Israel orders 16 southern Lebanon towns evacuated (Guardian). Russian billionaire\'s $500M yacht transits blocked Hormuz — US and Iran didn\'t object. Brent $111.16/bbl (+2.7%). WTI $100.09/bbl (+3.9%). HRANA: 1,701 civilians unchanged. Lebanon: 2,509+ killed. US: 15 KIA, 538 wounded. Gaza: 72,594 killed since Oct 7. The proposal is on the table — and Washington is saying no.' },
  { date: 'May 2', event: 'Day 64 — ISRAEL KILLS 13 IN SOUTH LEBANON — DOZENS OF STRIKES: Israel launches dozens of intense airstrikes across southern Lebanon — 13 killed including women and children (Lebanese health ministry/RTE/Al Jazeera/The National). Strikes hit Habboush, Zawtar, Mayfadoun despite continuing ceasefire. NYT: Israeli entrenchment in occupied south turning frustration with Hezbollah into support. Indian LPG carrier MT Sarv Shakti safely transits Hormuz (Times Now). Hamas voting for next leader. HRANA: 1,701 unchanged. Lebanon: 2,536+ killed. US: 15 KIA, 538 wounded. Day 64.' },
  { date: 'May 1', event: 'Day 63 — TRUMP DECLARES WAR "TERMINATED" — $8.6B ARMS BYPASS CONGRESS — 5,000 TROOPS FROM GERMANY — CNN: 16 US BASES DAMAGED: Trump sends letter to Congress declaring hostilities "terminated" — skirting War Powers 60-day deadline (Reuters/Guardian/Fox/CBC). Says ceasefire means no ongoing hostilities. Schumer: "That\'s bullshit. This is an illegal war." Sen. Shaheen: "After sixty days, Trump still does not have a strategy or way out." Democrats: naval blockade = ongoing hostilities. $8.6B ARMS BYPASS CONGRESS: Admin invokes emergency powers for military sales to Israel, Qatar, Kuwait, UAE without congressional review (Reuters). 5,000 TROOPS FROM GERMANY: Pentagon announces withdrawal from NATO ally Germany over 6-12 months — rift over Iran war (Reuters/NPR/NYT). GOP lawmakers condemn. CNN: 16 American military sites damaged by Iranian strikes — majority of US positions in Middle East (CNN investigation). Iran sends new peace proposal via Pakistan — Trump "not satisfied" (NYT/Guardian). Mojtaba Khamenei: foreigners have "no place except at the bottom of its waters." Israel kills 10+ in south Lebanon — Hezbollah drone wounds 2 IDF soldiers (LAT/NBC). Bodies of 5 incl. man and 3 sons recovered in Kfar Rumman. HRANA: 1,701 unchanged. Lebanon: 2,523+ killed. US: 15 KIA, 538 wounded. The president declared the war over while maintaining a blockade, pulling troops from allies, and bypassing Congress to sell $8.6B in weapons. Day 63.' },
  { date: 'Apr 30', event: 'Day 62 — TRUMP BRIEFED ON NEW STRIKE OPTIONS — OIL HITS $126 — ISRAEL KILLS 14 IN LEBANON — WAR POWERS DEADLINE EXPIRES: CENTCOM chief Admiral Brad Cooper briefs Trump on military options including \'short and powerful\' new strikes on Iran, seizing parts of Strait of Hormuz, and special forces raid to capture enriched uranium (Axios/Reuters). Trump preparing for LONG-TERM blockade — WSJ reports "boa constrictor" strategy. State Dept pushes "Maritime Freedom Construct" coalition for Hormuz — France/UK say only after hostilities cease (Reuters). CENTCOM requests Dark Eagle HYPERSONIC MISSILE deployment — first potential combat use (Financial Express). Trump tells Iran to "just give up," calls blockade "a success" (Al Jazeera). Rejects Hormuz-for-peace proposal again. Ghalibaf ridicules pipeline claims: "three days in, no well exploded" (CNN). Mojtaba Khamenei: guard nuclear tech "like its borders" (Times Now). OIL WARTIME HIGH: Brent $126/bbl intraday — pulled back to ~$110-114 (CNBC). UN: Iran executed 21, arrested 4,000+ since war began. Iran inflation 65.8%. Israel kills 14 in south Lebanon DESPITE ceasefire — 3 in Jebchit, 4 in Toul, 2 in Harouf (Al Jazeera/The National). 1 IDF soldier killed by Hezbollah fiber-optic drone evading radar. NPR: Israel "mirroring Gaza." Hegseth before Senate Armed Services — day 2 of grilling. USS Abraham Lincoln departing — first carrier to leave. HRANA: 1,701 unchanged. Lebanon: 2,523+ killed. US: 15 KIA, 538 wounded. War Powers 60-day deadline expires TONIGHT. Day 62.' },
  { date: 'Apr 29', event: 'Day 61 — PENTAGON: WAR COSTS $25 BILLION — HEGSETH GRILLED BY CONGRESS — RIAL RECORD LOW: Pentagon reveals first official war cost: $25 billion — mostly munitions (AP/NYT/WaPo). Hegseth testifies before House Armed Services Committee for first time. Democrats expose shifting justifications — Rep. Adam Smith: nuclear threat was "obliterated" in 2025 but "imminent" in Feb 2026? "Left us at exactly the same place." Hegseth claims public support — AP-NORC: only 30% approve. Gen. Caine admits pulling 3 carriers from Asia = "tradeoffs" on China. Pentagon seeks record $1.5T defense budget. Trump warns Iran to "get smart soon" (Reuters/NBC). Iran rial record low: 1.81M/$1 (AP/Reuters). Israeli double-tap strike kills 5 in Lebanon including 3 rescue workers (Reuters/BBC). Lebanon PM: "war crimes." 1.24M face food insecurity in Lebanon (UN). Oil surges: Brent $114-117/bbl (+4.7%). WTI $105. Gas $4.18/gallon — highest since 2022. Budget airlines seek $2.5B federal aid (NYT). Panama Canal traffic up 47% on Hormuz rerouting. HRANA: 1,701 civilians unchanged. Lebanon: 2,509+ killed. US: 15 KIA, 538 wounded. The war\'s cost is now official: $25 billion. And they want $1.5 trillion more.' },
]
