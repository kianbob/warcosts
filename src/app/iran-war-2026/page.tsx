...
const timeline = [
  ...
  { date: 'Apr 3-4', event: 'Day 35 — F-15E SHOT DOWN OVER IRAN. F-15E Strike Eagle (494th Fighter Squadron) shot down over western Iran by Iranian air defenses. Pilot rescued via CSAR, WSO (weapons systems officer) still missing. A-10 Warthog also hit by Iranian air defenses in separate incident. 7 total manned aircraft lost in war. 16+ MQ-9 Reaper drones lost. Italy sends naval forces to Gulf. Syria reports explosions in Damascus. Iran says "search for missing pilot still ongoing with full force." Pentagon requests $1.1T defense budget + $350B reconciliation. Brent $112.42. No ceasefire. Day 35.' },
]
