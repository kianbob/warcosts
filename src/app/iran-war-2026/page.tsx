...
const timeline = [
  ...
  { date: 'Apr 20', event: 'Day 52 — USS SPRUANCE SEIZES TOUSKA — BOTH SIDES HEADING TO ISLAMABAD: USS Spruance (DDG-111) fires on and seizes Iranian-flagged cargo ship M/V Touska in Gulf of Oman — Marines from USS Tripoli searching 5,000 containers (NYT/NPR/CNN). Iran calls it "piracy," warns retaliation (Tasnim). CENTCOM: 27 ships turned back. Despite threats, both sides now planning Islamabad talks — Vance departing Tue, Ghalibaf will attend if Vance does. Only 3 ships crossed Hormuz Monday (pre-war: 120+/day). Lebanon: Aoun appoints Simon Karam to lead Israel talks. Oil ~$95-96/bbl. HRANA: 1,701 civilians (254 children) — unchanged. Lebanon: 2,294 killed. US: 13 KIA, 520+ wounded. Ceasefire expires TOMORROW Apr 21.' },
]
