  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white border border-stone-200 rounded-lg p-4 text-center"><div className="text-2xl font-bold text-red-400">{fmtMoney(totalCost)}</div><div className="text-xs text-stone-400">Total Program Costs</div></div>
        <div className="bg-white border border-stone-200 rounded-lg p-4 text-center"><div className="text-2xl font-bold text-red-700">{weapons.length}</div><div className="text-xs text-stone-400">Major Programs</div></div>
      ...
      {/* By Category */}
      <h2 className="text-xl font-bold text-stone-900 mb-3">By Category</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        {categories.map(cat => {
          const catWeapons = weapons.filter(w => w.category === cat)
          return (
            <div key={cat} className="bg-white border border-stone-200 rounded-lg p-4">
