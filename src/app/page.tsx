...
const IRAN_BREAKING = {
  day: 60,
  headline: '🚨 TRUMP DECLARES WAR "TERMINATED" — Schumer: "That\'s bullshit" — $8.6B arms sales bypass Congress — 5,000 troops pulled from Germany — CNN: 16 US bases damaged by Iran — Israel kills 13 in Lebanon — Oil $110-114 — Gas $4.18 — 15 US KIA, 538 wounded',
  stats: [
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-4 gap-3 mb-6">
              {[
                ...
                { time: 'Day 64', text: 'ISRAEL KILLS 13 IN SOUTH LEBANON — dozens of intense strikes despite ceasefire. Indian LPG carrier transits Hormuz. NYT: Israeli entrenchment turning frustration into Hezbollah support. Hamas voting for next leader. Lebanon: 2,536+ killed. No new Iran casualties since ceasefire.', link: '/analysis/iran-2026' },
    { time: 'Day 63', text: 'TRUMP DECLARES WAR "TERMINATED" — skirting War Powers deadline. Schumer: "That\'s bullshit." $8.6B arms sales bypass Congress. 5,000 troops pulled from Germany. CNN: 16 US bases damaged by Iran. Iran peace proposal rejected. Israel kills 10+ in Lebanon.', link: '/analysis/iran-2026' },
    { time: 'Day 62', text: 'TRUMP BRIEFED ON NEW STRIKE OPTIONS — Oil hits $126 wartime high. Hypersonic missiles requested. Israel kills 14 in Lebanon despite ceasefire. Boa constrictor blockade strategy. War Powers 60-day deadline expires.', link: '/analysis/iran-2026' },
