      ...
      <div className="max-w-5xl mx-auto py-8">
          ...
          <table className="w-full text-sm border border-stone-200 rounded-lg overflow-hidden">
            <thead className="bg-white border border-stone-200">
              <tr>
                ...
                <th className="text-right p-3 text-stone-500 font-[family-name:var(--font-heading)]">2024 Aid</th>
                <th className="text-right p-3 text-stone-500 font-[family-name:var(--font-heading)]">Total Since 2001</th>
                <th className="text-right p-3 text-stone-500 font-[family-name:var(--font-heading)]">% Military</th>
                <th className="text-left p-3 text-stone-500 font-[family-name:var(--font-heading)]">Region</th>
              </tr>
            </thead>
            <tbody>
              {top10.map((c, i) => (
                <tr key={c.slug} className="border-t border-stone-200/50">
                  ...
                  <td className="p-3 text-red-700 font-semibold text-right">{fmtMoney(c.annual2024 * 1e6)}</td>
                  <td className="p-3 text-stone-600 text-right">{fmtMoney(c.totalSince2001 * 1e6)}</td>
                  <td className="p-3 text-right">
                    <span className={c.militaryPct >= 70 ? 'text-red-700 font-semibold' : 'text-stone-500'}>
                      {c.militaryPct}%
                    </span>
                  </td>
        ...
        <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6 border border-stone-200 mt-12">
          ...
          <ul className="space-y-2">
            <li><Link href="/foreign-aid" className="text-red-700 hover:underline">→ Foreign Aid Overview — Full Analysis</Link></li>
            <li><Link href="/foreign-aid/countries" className="text-red-700 hover:underline">→ All Countries — Complete Aid Database</Link></li>
            <li><Link href="/spending" className="text-red-700 hover:underline">→ US Military Spending Over Time</Link></li>
            <li><Link href="/contractors" className="text-red-700 hover:underline">→ Defense Contractors — Who Profits from Military Aid</Link></li>
            <li><Link href="/opportunity-cost" className="text-red-700 hover:underline">→ What Foreign Aid Could Buy at Home</Link></li>
          </ul>
        </div>
