...
const timeline = [
  ...
  { year: '1862', title: 'Year of Blood', desc: 'Shiloh (April): 23,746 casualties in two days — more American casualties in a single battle than any previous war in US history. Antietam (September 17): 22,717 casualties in a single day — the bloodiest day in American history. Fredericksburg (December): disastrous Union assault. The scale of killing is unprecedented.' },
