...
const sections = [
  ...
  },
  {
    ...
    articles: [
      ...
      { slug: 'lebanon-war-2026', title: 'Lebanon Under Fire Again: The 2026 War Nobody Asked For', desc: '1,110+ killed. 3,119 wounded. 1M+ displaced. Israel\'s third Lebanon war in 20 years — and American taxpayers are paying for it.' },
      { slug: 'civilian-toll-iran-2026', title: '3,461 Dead in 30 Days: The Human Cost of the Iran War', desc: 'HRANA data: 3,461 killed, 1,551 civilians, 228+ children. The Minab school attack killed 168. What "precision strikes" look like at scale.' },
      { slug: 'oil-price-shock-2026', title: '$116 Oil and Counting: How the Iran War Is Hitting Your Wallet', desc: 'Brent crude: $82 → $119.50 peak → $116. Hormuz blocked. Gas prices soaring. Foreign wars always come home through the gas pump.' },
