...
export const metadata: Metadata = {
  ...
  description: 'Operation Epic Fury Day 19: 13 US troops dead, 200 wounded. 1,444+ Iranians killed (HRANA: 3,114). 900+ killed in Lebanon. 1M+ displaced. $16.5B+ in 12 days. South Pars gas field struck — oil nears $110. Israel kills intelligence minister Khatib. Iran retaliates with cluster munitions on Tel Aviv — 2 dead. Central Beirut bombed without warning. Who benefits?',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
...
const whoLoses = [
  ...
  { who: 'American Troops', how: 'Iran fired missiles at 27+ US bases across Bahrain, Kuwait, Jordan, Qatar, Iraq, Saudi Arabia, UAE, and more. 13 US troops dead by Day 19 — including all 6 crew members of a KC-135 refueling aircraft that crashed in Iraq. ~200 wounded (CENTCOM, Mar 17). A dozen MQ-9 Reaper drones destroyed. 50,000+ now deployed. 2,500 MORE Marines (31st MEU + USS Tripoli) ordered from Japan. 3 US F-15E jets shot down by Kuwaiti air defenses (friendly fire). Russia is providing Iran with real-time intelligence on US positions (WaPo, NYT, CNN, NBC). IRGC now directly threatening UAE, calling US "hideouts" there "legitimate targets." CIA Director Ratcliffe tells Senate the war will take 4-6 weeks. Trump says he\'s "not afraid" to put troops on the ground. Troops are in harm\'s way for a war Congress never authorized.' },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Mar 18, 2026 — Day 19</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 19: 13 US troops dead, 200 wounded. 1,444+ Iranians killed (HRANA says 3,114 including 1,354 civilians and 207 children).
          900+ killed in Lebanon. 1 million+ displaced.
          3.2 million Iranians displaced. 7,000+ targets struck in Iran alone (15,000+ combined). CSIS estimates $16.5 billion spent through first 12 days.
          Israel strikes South Pars gas field — the largest attack on Iran&apos;s energy production — oil nears $110/barrel.
          Israel kills intelligence minister Esmaeil Khatib — third senior official assassinated in 48 hours.
          Iran retaliates with cluster munitions on Tel Aviv — 2 civilians killed in Ramat Gan.
          Central Beirut bombed without warning — 10+ killed. Trump says he&apos;s &ldquo;not afraid&rdquo; to put US troops on the ground.
          CIA Director Ratcliffe tells Senate war will take 4-6 weeks. 56% of Americans oppose the war. No exit strategy. No end in sight.
        </p>
