...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 28',
  description: 'Operation Epic Fury Day 28: Iran blocks CHINESE ships at Hormuz — even "friendly" nations now denied passage. Trump extends power-plant deadline AGAIN (now April 6). Israel defense minister warns attacks "will escalate." Arak nuclear facility struck. Oil surges to $108. HRANA: 3,300+ killed in Iran (1,492+ civilians). Lebanon: 1,110+ killed. US: 15 dead (13 KIA + 2 non-combat). Global fertilizer/food crisis worsening. G7 meets in France. Blinken denies supporting attack. No ceasefire. Who benefits?',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 28: Iran blocks Chinese ships at Hormuz. Trump extends deadline again. Israel warns attacks "will escalate." Arak nuclear site struck. Oil at $108. Global food crisis. Who benefits?',
...
const whoLoses = [
  ...
  { who: 'Iranian Civilians', how: 'Iran Health Ministry: 1,500+ killed, 20,984 injured by Day 23 — 7 hospitals evacuated, 36 ambulances damaged. HRANA (independent): 3,230 killed — 1,167 military, 1,406 civilians (210+ children). Victims range from 8 months to 88 years old. 55 healthcare workers wounded, 11 killed. 25 hospitals damaged, 9 out of service. 3.2 MILLION Iranians displaced (UNHCR). Non-military sites hit across Tehran, Isfahan, Qom, Karaj, Kermanshah, Tabriz, Lorestan, Bushehr. 9,000+ strikes conducted (CENTCOM, Mar 24). Kharg Island hit. Iran offline for 24+ days. Food distribution disrupted. Iran\'s new top security chief is a hardline IRGC general — the war has consolidated military control over Iran, the exact opposite of the stated US goal. Many of these people were protesting their own government just weeks ago.' },
