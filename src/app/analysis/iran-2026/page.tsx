...
export const metadata: Metadata = {
  ...
  description: 'Operation Epic Fury Day 24: Trump POSTPONES power plant ultimatum 5 days — claims "very strong talks" with Iran. Iran disputes, calls it a ploy to "buy time." Unprecedented strikes continue — civilians killed in Khorramabad & Tabriz even as Trump claims negotiations. 2,000+ killed across all theaters (NYT). Iran warns Hormuz "completely closed" if power plants hit. Oman brokers safe passage. Oil drops to ~$100 on talk of talks. IEA: crisis "worse than 1973 and 1979 combined." Who benefits?',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 24: Trump postpones ultimatum, claims talks. Iran disputes. Bombs keep falling. 2,000+ killed. No congressional approval. Who benefits?',
...
const whoLoses = [
  ...
  { who: 'American Troops', how: 'Iran fired missiles at 27+ US bases across Bahrain, Kuwait, Jordan, Qatar, Iraq, Saudi Arabia, UAE, and more. 13 US troops dead by Day 21 — including all 6 crew members of a KC-135 refueling aircraft that crashed in Iraq. ~200 wounded (CENTCOM, Mar 17). A dozen MQ-9 Reaper drones destroyed. 50,000+ deployed — and now THOUSANDS MORE: USS Boxer departs San Diego with 2,200+ Marines (Reuters, Mar 20), on top of 2,500 Marines (31st MEU + USS Tripoli) already ordered from Japan. A US F-35 made an emergency landing after a combat mission over Iran on Day 21 — possibly struck by Iranian fire, which would be the first US jet hit. 3 US F-15E jets shot down by Kuwaiti air defenses (friendly fire). Russia providing Iran with real-time intelligence on US positions (WaPo, NYT, CNN, NBC). Poland evacuates all troops from Iraq. CIA Director Ratcliffe tells Senate the war will take 4-6 weeks. Pentagon demands $200 BILLION from Congress. Trump says he\'s "not putting troops anywhere" then hedges: "and if I was I wouldn\'t tell you." Netanyahu says there needs to be a "ground component." Troops are in harm\'s way for a war Congress never authorized.' },
  ...
  { who: 'Iranian Civilians', how: 'Iran Health Ministry: 1,500+ killed, 20,984 injured by Day 23 — 7 hospitals evacuated, 36 ambulances damaged. HRANA (independent): 3,230 killed — 1,167 military, 1,406 civilians (210+ children). Victims range from 8 months to 88 years old. 55 healthcare workers wounded, 11 killed. 25 hospitals damaged, 9 out of service. 3.2 MILLION Iranians displaced (UNHCR). Non-military sites hit across Tehran, Isfahan, Qom, Karaj, Kermanshah, Tabriz, Lorestan, Bushehr. 15,000+ targets struck total. Kharg Island hit. Iran offline for 23+ days. Food distribution disrupted. Trump now threatens to "obliterate" their power plants — cutting electricity to 88 million people. Many of these people were protesting their own government just weeks ago.' },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Mar 23, 2026 — Day 24</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 24: 13 US troops dead, 200+ wounded. 2,000+ killed across all theaters (NYT). 1,500+ killed in Iran (state media), 3,230+ (HRANA — 1,406 civilians, 210+ children).
          1,000+ killed in Lebanon, 2,600+ wounded, 1 million+ displaced.
          3.2 million Iranians displaced. 8,000+ combat flights flown, 130 vessels destroyed.
          ...
          Iran warns Hormuz will be &ldquo;completely closed&rdquo; if power plants hit. Oil drops to ~$100 on talk of talks.
