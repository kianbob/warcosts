...
export const metadata: Metadata = {
  ...
  description: 'Day 67: UAE under attack for 2nd day. USS Truxtun/Mason transit Hormuz under fire. Araghchi heads to Beijing. Oil $113/bbl. 15 US KIA, 538 wounded.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 67: UAE under attack for 2nd consecutive day — air defenses engaging Iranian missiles/drones. USS Truxtun and Mason transit Hormuz under sustained Iranian barrage. Araghchi heads to Beijing. South Korea reviewing joining Project Freedom. Ghalibaf: Iran has not even started. Lebanon: 2,659+ killed.',
