...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 64 — TRUMP DECLARES WAR "TERMINATED" — $8.6B ARMS SALES BYPASS CONGRESS — 5,000 TROOPS WITHDRAWN FROM GERMANY — ISRAEL KILLS 13 IN LEBANON — CNN: 16 US BASES DAMAGED — GAS $4.18',
  description: 'Operation Epic Fury Day 64: Trump tells Congress hostilities "terminated" — skirting War Powers 60-day deadline. Schumer: "That\'s bullshit. This is an illegal war." Admin bypasses congressional review for $8.6B arms sales to Israel, Qatar, Kuwait, UAE. 5,000 troops withdrawn from NATO ally Germany. CNN: 16 US military sites damaged by Iran — majority of US positions in Middle East. Israel kills 13 in south Lebanon despite ceasefire. Iran sends new peace proposal via Pakistan — Trump "not satisfied." Iran threatens "long and painful strikes" if attacks resume. Indian LPG carrier transits Hormuz. HRANA: 1,701 civilians unchanged. US: 15 KIA, 538 wounded. Lebanon: 2,536+ killed.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 64: Trump declares war terminated to dodge War Powers deadline. $8.6B arms sales bypass Congress. 5,000 troops pulled from Germany. CNN: 16 US bases damaged. Israel kills 13 in Lebanon. Gas $4.18.',
