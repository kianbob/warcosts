...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 51 — HORMUZ RE-CLOSED — VANCE HEADING TO PAKISTAN — IRAN REFUSES DELEGATION',
  description: 'Operation Epic Fury Day 51: Iran RE-CLOSES Hormuz after US refuses to lift naval blockade. IRGC gunboats fire on tanker. Oil rebounds to ~$90-95/bbl. Trump announces Vance, Witkoff, Kushner heading to Islamabad for Round 2 talks. Iran refuses to send delegation "as long as there is a naval blockade." Trump threatens to destroy every bridge and power plant in Iran. Ceasefire expires Apr 21 — 2 days left. Lebanon: 2,294 killed. HRANA: 1,701 Iranian civilians (254 children).',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 51: Iran re-closes Hormuz. IRGC fires on tanker. Vance heading to Pakistan. Iran refuses to send delegation. Trump threatens bridges and power plants. Ceasefire expires in 2 days.',
