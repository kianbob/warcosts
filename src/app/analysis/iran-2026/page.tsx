...
export const metadata: Metadata = {
  ...
  description: 'Operation Epic Fury Day 18: 13 US troops dead, 200 wounded. 1,444+ Iranians killed. 886+ killed in Lebanon. 1M+ displaced. $16.5B+ in 12 days. 7,000+ targets struck in Iran alone. Hormuz closed. Oil surging. Amnesty confirms US hit school killing 170 girls. NATO rejects Hormuz mission. Who benefits?',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Mar 17, 2026 — Day 18</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 18: 13 US troops dead, 200 wounded. 1,444+ Iranians killed. 886+ killed in Lebanon. 1 million+ displaced.
          ...
          Amnesty International confirms US responsible for school attack killing 170+ girls. NATO allies reject Hormuz mission.
          Trump calls Iran a &ldquo;paper tiger&rdquo; while delaying his China trip because of the war.
          Israel strikes Tehran and Beirut simultaneously. Oil surging. Gulf states pressing US to &ldquo;neutralize Iran for good.&rdquo;
          886 killed in Lebanon, 1 million displaced. Israel expands ground operation. 56% of Americans oppose the war. No exit strategy. No end in sight.
        </p>
