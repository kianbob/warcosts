...
export const metadata: Metadata = {
  ...
  description: 'Operation Epic Fury Day 22: Trump signals "winding down" — Israel vows to ESCALATE. Iran fires missiles at Diego Garcia (2,500 miles away). Natanz nuclear site struck again. Treasury eases oil sanctions. 22 nations pledge Hormuz passage. 8,000+ targets hit, 130 vessels destroyed. Eid under bombs in Beirut. 1,394+ Iranian civilians killed. Who benefits?',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Mar 21, 2026 — Day 22</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 22: 13 US troops dead, 200+ wounded. 1,394+ Iranian civilians killed (HRANA), 3,114+ total.
          ...
          The Pentagon demands $200 BILLION from Congress. Trump signals &ldquo;winding down&rdquo; — then Israel vows to &ldquo;escalate significantly.&rdquo;
          Iran fires missiles at Diego Garcia — 2,500 miles from Iranian territory. Natanz nuclear site struck again.
          Treasury eases oil sanctions in desperation. 22 countries pledge Hormuz safe passage.
          Eid al-Fitr arrives with bombs falling on Beirut. 56% of Americans oppose the war. No exit strategy. No end in sight.
        </p>
