...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 39',
  description: 'Operation Epic Fury Day 39: IRGC intelligence chief Khademi assassinated. Kharg Island struck again. Israel hits Iran\'s largest petrochemical complex. 3 Tehran airports bombed. Trump\'s Tuesday deadline: "complete demolition" of power plants if Hormuz stays closed. Coordinated Iran-Hezbollah-Houthi strike kills 4 in Haifa. HRANA: 3,597+ killed. Oil ~$110/bbl. No ceasefire.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 39: IRGC intel chief killed. Kharg Island struck again. 3 airports bombed. Trump\'s Tuesday deadline looms. Coordinated Iran-Hezbollah-Houthi attack. HRANA: 3,597+ killed. Oil ~$110/bbl. No ceasefire.',
...
const timeline = [
  ...
  { date: 'Apr 7 (Day 39)', event: 'IRGC INTELLIGENCE CHIEF ASSASSINATED — KHARG ISLAND STRUCK AGAIN — TRUMP\'S TUESDAY DEADLINE: Israel kills IRGC intelligence chief Major General Majid Khademi in dawn strike — latest high-value targeted killing. Israel strikes three airports in Tehran, hitting Iranian planes and helicopters. Khorramabad International Airport in western Iran also hit. Israel strikes Iran\'s LARGEST PETROCHEMICAL COMPLEX serving South Pars gasfield, plus petrochemical compound in Shiraz. Two electricity-generating units for South Pars targeted — Iran calls it "huge escalation" aimed at "destroying survival capabilities of Iranian people." Mehr reports strike on KHARG ISLAND oil hub — "major development if confirmed." Synagogue in central Tehran destroyed in strikes. Israeli strike hits Yahya Abad railway bridge in Kashan — 2 killed. US-Israeli strikes on residential areas in Alborz province kill 18 (including 2 children); 9 killed in Shahriar residential neighborhood. IAEA chief: Bushehr attacks "pose very real danger to nuclear safety and must stop." Trump issues STRICT DEADLINE: threatens "complete demolition" of Iran\'s power plants and bridges if Hormuz not reopened by 8pm Washington time Tuesday (00:00 GMT Wednesday). Experts: targeting civilian infrastructure is a war crime. Iran\'s military dismisses threats as "delusional" — says they cannot mask US "disgrace and humiliation." Drone from Iran kills couple in Kurdish Iraq when it crashes into their home. Two blasts heard near Erbil airport. CENTCOM: 13,000+ Iranian targets struck. Brent crude ~$110/barrel. WTI ~$113. No ceasefire. Day 39.' },
]
...
const whoLoses = [
  ...
  { who: 'American Troops', how: '15 US troops dead by Day 39. 520+ wounded (CENTCOM/Intercept). Both F-15E crew rescued after harrowing 2-day CSAR inside Iran (170+ aircraft, hundreds of troops). 15 more wounded at Ali Al Salem Air Base (Kuwait) by Iranian drone strike on Day 38. 7 manned aircraft lost. 16+ MQ-9 Reaper drones destroyed. 52,000+ deployed. Russia providing Iran with real-time intelligence on US positions. Pentagon requests $1.1T defense budget + $350B reconciliation. Troops are in harm\'s way for a war Congress never authorized.' },
  ...
  { who: 'Iranian Civilians', how: 'HRANA (independent): 3,597+ killed — 1,665 civilians, 1,221 military, 711 unclassified — by Day 39. Iranian Health Ministry: 2,076 killed, 26,500 injured. Victims range from 8 months to 88 years old. Pasteur Institute destroyed. 3 Tehran airports bombed. Iran\'s largest petrochemical complex and South Pars electricity units struck — Iran calls it targeting "survival capabilities." Synagogue in central Tehran destroyed. Railway bridge in Kashan hit (2 killed). 18 killed in Alborz residential strikes including 2 children. 3.2M+ Iranians displaced (UNHCR). 13,000+ strikes (CENTCOM). Trump threatens "complete demolition" of power plants. IAEA: Bushehr attacks "pose very real danger to nuclear safety." The war has consolidated military control over Iran — the exact opposite of the stated US goal.' },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Apr 7, 2026 — Day 39</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 35: 15 US troops dead, 300+ wounded. Iran: 3,519+ killed (HRANA — 1,607 civilians, 244+ children). Lebanon: 1,345+ killed. 7 manned aircraft lost. Pentagon requests $1.1T budget.
          Israel: 19 killed, 5,768 wounded. 3.2 million Iranians displaced. 13,000+ strikes conducted, 150+ vessels destroyed.
          The Pentagon demands $200 BILLION from Congress. Hegseth says Iran firing the lowest number of missiles/drones in 24 hours — claims
          Iranian military &ldquo;demoralized&rdquo; with &ldquo;widespread desertions.&rdquo; But Iran rejects every ceasefire proposal, imposes tolls on Hormuz shipping,
          and strikes a Kuwaiti oil tanker off Dubai. Trump tells European allies &ldquo;Go get your own oil!&rdquo; and threatens to seize Kharg Island.
          Oil surges to $118/barrel — a record 59% monthly gain. US gas hits $4/gallon. Pentagon preparing for weeks of ground operations.
          IMF warns of higher prices and slower global growth. Philippines in national energy emergency.
          IEA chief calls this &ldquo;worse than 1973 and 1979 combined.&rdquo; No exit strategy. No end in sight.
        </p>
