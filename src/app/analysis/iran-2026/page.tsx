...
export const metadata: Metadata = {
  ...
  description: 'Day 69: Rubio declares Epic Fury "over." Trump pauses Project Freedom. 1-page MOU framework near. Israel kills Radwan commander in Beirut. Oil crashes to $97. 15 US KIA, 538 wounded.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 69: Rubio declares Operation Epic Fury "over" — shifting to defensive posture. Trump pauses Project Freedom citing deal progress. 1-page MOU near. Israel strikes Beirut — kills Hezbollah Radwan commander. Oil crashes 11% to $97. Iran reviewing US proposal. Lebanon: 2,702+ killed.',
