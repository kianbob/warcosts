...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 47 — TRUMP DECLARES WAR "OVER" — BLOCKADE TIGHTENS — IRAN THREATENS RED SEA',
  description: 'Operation Epic Fury Day 47: Trump declares war "over" on Fox News — then sends 6,000 more troops + USS George HW Bush. US blockade "completely halted" Iran trade — 9 ships turned back in 48 hours. Iran threatens to expand control to Red Sea. Pakistan Army Chief in Tehran. Israel-Lebanon "launch direct negotiations." IEA: "demand destruction" underway. Harvard: war could cost $1 trillion. Lebanon: 2,124 killed. HRANA: 1,701 Iranian civilians (254 children). Ceasefire expires Apr 21 — 6 days left.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 47: Trump declares war "over" — sends 6,000 more troops. US blockade halts all Iran trade. Iran threatens Red Sea expansion. Harvard: $1 trillion war. Lebanon: 2,124 killed. Ceasefire expires in 6 days.',
