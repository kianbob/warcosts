...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 40 — CEASEFIRE',
  description: 'Operation Epic Fury Day 40: CEASEFIRE ANNOUNCED. Trump declares 2-week pause. Pakistan-mediated talks begin Apr 10 in Islamabad. Iran agrees to reopen Hormuz. Oil crashes 15%. 5,000+ killed across region (Reuters). 1,600+ Iranian civilians. Missiles still fired after ceasefire. Israel still striking.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 40: CEASEFIRE. Trump announces 2-week pause. Pakistan mediates. Iran agrees to reopen Hormuz. Oil crashes 15%. 5,000+ killed (Reuters). Talks begin Apr 10 in Islamabad.',
...
const timeline = [
  ...
  { date: 'Apr 8 (Day 40)', event: 'MARKETS REACT — OIL CRASHES 15%: Oil plunges 15%+ on ceasefire news (US crude futures). S&P 500 futures jump 2.2%. Ceasefire terms: conditional on Iran reopening Strait of Hormuz, 2-week pause in hostilities, Pakistan-mediated negotiations in Islamabad starting April 10. IAEA warned one strike was just 250 feet from Bushehr operating nuclear plant — "could cause severe radiological accident." The 39-day war killed 5,000+ people across nearly a dozen countries (Reuters), with 1,600+ civilians in Iran. Whether the ceasefire holds is deeply uncertain — missiles were still flying hours after it was announced, and Israel continued striking even after the White House said Tel Aviv had accepted. The Islamabad talks, based on Iran\'s 10-point counterproposal (including reconstruction aid, sanctions relief, and a new Hormuz framework), represent the first concrete diplomatic process since the war began. Day 40.' },
]
...
const whoLoses = [
  ...
  { who: 'American Troops', how: '15 US troops dead by Day 40. 520+ wounded (CENTCOM/Intercept). Both F-15E crew rescued after harrowing 2-day CSAR inside Iran (170+ aircraft, hundreds of troops). 7 manned aircraft lost. 16+ MQ-9 Reaper drones destroyed. 52,000+ deployed. CEASEFIRE announced Day 39 — but missiles still flying after it took effect. Pentagon requests $1.1T defense budget + $350B reconciliation. Troops remain in harm\'s way for a war Congress never authorized.' },
  ...
  { who: 'Iranian Civilians', how: 'Reuters: 5,000+ killed across nearly a dozen countries by Day 40. 1,600+ civilians in Iran. HRANA (independent): 3,597+ killed by Day 39. CEASEFIRE announced Day 39 — 2-week pause, Pakistan-mediated talks in Islamabad starting Apr 10. But missiles were STILL launched from Iran after ceasefire took effect at 8 PM ET. Israel still attacking even after White House said Tel Aviv accepted. IAEA: strikes near Bushehr "could cause severe radiological accident" — one strike 250 feet from operating nuclear plant. 3.2M+ Iranians displaced (UNHCR). 13,000+ strikes (CENTCOM). Oil crashed 15% on ceasefire news. The war consolidated military control over Iran — the exact opposite of the stated US goal.' },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-amber-700 text-amber-100">🕊️ CEASEFIRE — Updated Apr 8, 2026 — Day 40</span>
        </div>
