...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 60 — TRUMP: IRAN IN "STATE OF COLLAPSE" — UAE QUITS OPEC — GCC SUMMIT IN JEDDAH — BESSENT: PUMPING "WILL COLLAPSE" — RUBIO COLD ON IRAN DEAL — 16 LEBANON TOWNS EVACUATED — OIL $111',
  description: 'Operation Epic Fury Day 60: Trump claims Iran told US it is in "state of collapse." UAE quits OPEC effective May 1. GCC emergency summit in Jeddah — first since Gulf states dragged into war. Bessent: Iran oil pumping "will soon collapse." Rubio cold on Iran peace proposal. Israel orders 16 Lebanon towns evacuated. Iran bans steel exports. Brent $111. HRANA: 1,701 civilians unchanged. US: 15 KIA, 538 wounded. Lebanon: 2,509+ killed.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 60: Trump claims Iran in "state of collapse." UAE quits OPEC. GCC emergency summit. Rubio cold on Iran deal. Bessent: pumping "will collapse." 16 Lebanon towns evacuated. Brent $111.',
