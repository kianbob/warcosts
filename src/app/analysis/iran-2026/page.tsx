...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 52 — USS SPRUANCE SEIZES IRANIAN SHIP — MARINES SEARCH 5,000 CONTAINERS — IRAN SAYS PIRACY — BOTH SIDES HEADING TO ISLAMABAD — CEASEFIRE EXPIRES TOMORROW',
  description: 'Operation Epic Fury Day 52: USS Spruance fires on and seizes Iranian cargo ship M/V Touska in Gulf of Oman — Marines searching 5,000 containers. Iran calls it piracy, warns of retaliation. Despite threats, BOTH sides now planning to send delegations to Islamabad this week — Vance departing Tuesday, Ghalibaf will attend if Vance does. Only 3 ships crossed Hormuz Monday (pre-war: 120+/day). Oil ~$95-96/bbl. Ceasefire expires TOMORROW Apr 21. Lebanon: 2,294 killed. HRANA: 1,701 Iranian civilians (254 children).',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 52: USS Spruance seizes Iranian ship Touska — Marines searching 5,000 containers. Iran calls it piracy. Both sides now heading to Islamabad. Hormuz at standstill (3 ships). Ceasefire expires tomorrow.',
