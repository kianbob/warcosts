...
export const metadata: Metadata = {
  ...
  description: 'Operation Epic Fury Day 25: Iran fires missiles at Tel Aviv (6+ injured, 3 buildings damaged) and Kurdish Iraq (6 killed, 30 wounded) — proving capability intact despite 9,000+ US strikes. Lebanon EXPELS Iranian ambassador. Israel claims permanent "security zone" up to Litani River. MBS secretly pushing Trump to continue war — sees "historic opportunity." Philippines declares NATIONAL ENERGY EMERGENCY — first country to do so. Iran appoints hardliner Zolghadr as security chief. Oil rebounds to $103. Pakistan offers to mediate. Who benefits?',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 25: Iran hits Tel Aviv. Lebanon expels Iranian envoy. Israel claims permanent Lebanon occupation. MBS pushes Trump to keep fighting. Philippines declares energy emergency. Who benefits?',
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Mar 24, 2026 — Day 25</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 25: 13-14 US troops dead, 200+ wounded. 2,000+ killed across all theaters (NYT). 1,500+ killed in Iran (state media), 3,230+ (HRANA — 1,406 civilians, 210+ children).
          1,000+ killed in Lebanon, 2,600+ wounded, 1 million+ displaced.
          3.2 million Iranians displaced. 9,000+ strikes conducted, 130 vessels destroyed.
          The Pentagon demands $200 BILLION from Congress. Trump postpones his 48-hour power plant ultimatum by 5 days —
          claims &ldquo;very strong talks&rdquo; with Iran. Iran immediately disputes, calls it a ploy to &ldquo;buy time for military plans.&rdquo;
          Bombs keep falling even as Trump claims negotiations — civilians killed in Khorramabad and Tabriz.
          Iran warns Hormuz will be &ldquo;completely closed&rdquo; if power plants hit. Oil rebounds to ~$103 as Iran disputes talks. Philippines declares national energy emergency.
