...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 49 — IRAN OPENS HORMUZ — OIL CRASHES 13% — TRUMP BANS ISRAEL FROM BOMBING LEBANON — MOU PROGRESS',
  description: 'Operation Epic Fury Day 49: Iran FM declares Strait of Hormuz "completely open" for ceasefire duration (Reuters). Oil crashes 13% to ~$86/bbl. Trump bans Israel from bombing Lebanon: "PROHIBITED by the U.S.A." Axios: progress on 3-page MOU, $20B cash-for-uranium deal considered. Trump: "very close to making a deal." Lebanon: 2,294 killed. HRANA: 1,701 Iranian civilians (254 children). Ceasefire expires Apr 21 — 4 days left.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 49: Iran opens Hormuz. Oil crashes 13%. Trump bans Israel from bombing Lebanon. Progress on MOU — $20B cash-for-uranium deal. Lebanon: 2,294 killed. Ceasefire expires in 4 days.',
