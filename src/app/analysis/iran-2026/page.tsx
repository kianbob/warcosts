...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 53 — CEASEFIRE EXPIRES — TRUMP WON\'T EXTEND — NAVY SEALS SEIZE OIL TANKER — VANCE DELAYED — IRAN UNDECIDED ON TALKS — XI DEMANDS HORMUZ OPEN',
  description: 'Operation Epic Fury Day 53: CEASEFIRE EXPIRES TODAY/TOMORROW — Trump says he does NOT want to extend it, military "raring to go." Navy SEALs board MT Tifani oil tanker near Sri Lanka (~2M barrels of Iranian crude). Vance\'s Pakistan departure DELAYED for White House meetings. Iran still hasn\'t confirmed Islamabad Round 2. Ghalibaf: won\'t attend "under shadow of threats." Privately: Iranian delegation making plans. Xi Jinping calls for Hormuz reopening (first time). CENTCOM: 28 ships turned back under blockade. France: war costing €4-6B. IEA: "biggest energy crisis in history." Oil ~$95.75/bbl. HRANA: 1,701 Iranian civilians (254 children). Lebanon: 2,294 killed. US: 13 KIA, 520+ wounded.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 53: Ceasefire expires — Trump won\'t extend. Navy SEALs seize Iranian oil tanker. Vance delayed. Iran undecided on talks. Xi demands Hormuz open. IEA: biggest energy crisis in history.',
