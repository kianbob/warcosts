...
export const metadata: Metadata = {
  ...
  description: 'Operation Epic Fury Day 17: 13+ US troops dead. 1,444+ Iranians killed. 850+ killed in Lebanon. $16.5B+ in 12 days. 15,000+ targets struck. Kharg Island hit. Hormuz closed. Oil at $106. Israel expands Lebanon ground op. 56% of Americans oppose. Who benefits?',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Mar 16, 2026 — Day 17</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 17: 13+ US troops dead. 1,444+ Iranians killed. 850+ killed in Lebanon. 3.2 million displaced. 15,000+ targets struck.
          ...
          Mojtaba Khamenei appoints former IRGC chief as military adviser. Oil at $106/barrel, peaked at $119.50.
          850 killed in Lebanon, 830K displaced. Israel expands ground operation in Lebanon. 56% of Americans oppose the war. No exit strategy. No end in sight.
        </p>
