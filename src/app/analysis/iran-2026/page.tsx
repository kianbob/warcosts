...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 40 — CEASEFIRE FRACTURING',
  description: 'Operation Epic Fury Day 40: Ceasefire already fracturing. Israel pounds Lebanon with heaviest strikes of war DESPITE truce. Netanyahu: ceasefire "does not include Lebanon." Iran considers backing out. Oil crashes 15% to $95/bbl. 5,000+ killed (Reuters). 1,665+ Iranian civilians (HRANA). Talks begin Apr 10 in Islamabad.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 40: Ceasefire fracturing. Israel pounds Lebanon with heaviest strikes of war DESPITE truce. Iran considers backing out. Oil crashes 15% to $95/bbl. 5,000+ killed (Reuters). 1,665+ Iranian civilians. Talks Apr 10 in Islamabad.',
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-amber-700 text-amber-100">🕊️ CEASEFIRE FRACTURING — Updated Apr 9, 2026 — Day 40</span>
        </div>
