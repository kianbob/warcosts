...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 62 — TRUMP BRIEFED ON NEW STRIKE OPTIONS — OIL HITS $126 WARTIME HIGH — ISRAEL KILLS 14 IN LEBANON — HYPERSONIC MISSILES REQUESTED — WAR POWERS DEADLINE EXPIRES — GAS $4.18',
  description: 'Operation Epic Fury Day 62: CENTCOM chief briefs Trump on new strike options including Hormuz seizure and special forces uranium raid. Brent hits $126/bbl wartime high. Dark Eagle hypersonic missile requested for Middle East. Trump tells Iran to "just give up." WSJ: "boa constrictor" long-term blockade strategy. State Dept pushes "Maritime Freedom Construct" coalition — allies refuse until hostilities end. Israel kills 14 in south Lebanon despite ceasefire. Hezbollah fiber-optic drones evade Israeli radar. War Powers 60-day deadline expires today. HRANA: 1,701 civilians unchanged. US: 15 KIA, 538 wounded. Lebanon: 2,523+ killed.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 62: Trump briefed on new strike options — oil hits $126 wartime high. Hypersonic missiles requested. Israel kills 14 in Lebanon. War Powers deadline expires. Boa constrictor blockade strategy. Gas $4.18.',
