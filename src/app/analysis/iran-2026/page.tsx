...
export const metadata: Metadata = {
  ...
  description: 'Operation Epic Fury Day 20: Pentagon demands $200B from Congress. Iran strikes Qatar\'s Ras Laffan LNG terminal — 17% capacity sidelined for 3-5 years. Oil hits $119/barrel. Lebanon: 1,001 dead. HRANA: 3,114 killed in Iran. 13 US troops dead, 200 wounded. "Largest strike package yet." Global markets crash. Who benefits?',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
...
const whoLoses = [
  ...
  { who: 'American Troops', how: 'Iran fired missiles at 27+ US bases across Bahrain, Kuwait, Jordan, Qatar, Iraq, Saudi Arabia, UAE, and more. 13 US troops dead by Day 20 — including all 6 crew members of a KC-135 refueling aircraft that crashed in Iraq. ~200 wounded (CENTCOM, Mar 17). A dozen MQ-9 Reaper drones destroyed. 50,000+ now deployed. 2,500 MORE Marines (31st MEU + USS Tripoli) ordered from Japan. 3 US F-15E jets shot down by Kuwaiti air defenses (friendly fire). Russia is providing Iran with real-time intelligence on US positions (WaPo, NYT, CNN, NBC). IRGC now directly threatening UAE, calling US "hideouts" there "legitimate targets." CIA Director Ratcliffe tells Senate the war will take 4-6 weeks. Pentagon demands $200 BILLION from Congress. Trump says he\'s "not putting troops anywhere" then hedges: "and if I was I wouldn\'t tell you." Troops are in harm\'s way for a war Congress never authorized.' },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Mar 19, 2026 — Day 20</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 20: 13 US troops dead, 200 wounded. 1,444+ Iranians killed (HRANA says 3,114 including 1,354 civilians and 207 children).
          1,001 killed in Lebanon. 1 million+ displaced.
          3.2 million Iranians displaced. 7,000+ targets struck in Iran alone (15,000+ combined).
          The Pentagon is now demanding $200 BILLION from Congress. Iran retaliates for South Pars by striking Qatar&apos;s
          Ras Laffan — the world&apos;s largest LNG terminal — sidelining 17% of Qatar&apos;s capacity for 3-5 years.
          Oil hits $119/barrel intraday. European gas prices more than double. Global markets crash.
          Hegseth announces the &ldquo;largest strike package yet.&rdquo; Trump says he &ldquo;knew nothing&rdquo; about Israel&apos;s
          South Pars strike. 56% of Americans oppose the war. No exit strategy. No end in sight.
        </p>
