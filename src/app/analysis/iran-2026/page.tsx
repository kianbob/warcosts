...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 66 — "PROJECT FREEDOM" LAUNCHES — 2 US SHIPS TRANSIT HORMUZ — IRAN FIRES 4 MISSILES AT UAE — CEASEFIRE FRACTURES — HEZBOLLAH REJECTS TRUCE — LEBANON: 2,659 KILLED',
  description: 'Operation Epic Fury Day 66: Trump launches "Project Freedom" to escort ships through Hormuz — Iran military warns US forces will be "targeted and attacked." 2 US-flagged ships transit strait under escort. Iran fires 4 cruise missiles at UAE — FIRST ATTACK since ceasefire — 3 intercepted, ADNOC tanker targeted with drones. Hezbollah leader Qassem rejects ceasefire entirely. Reuters: 2,600+ killed in Lebanon, several thousand Hezbollah fighters dead. Lebanon: 2,659+ killed. HRANA: 1,701 civilians unchanged. US: 15 KIA, 538 wounded.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 66: Project Freedom launches — 2 US ships transit Hormuz under escort. Iran fires 4 missiles at UAE, breaking ceasefire. ADNOC tanker hit. Hezbollah rejects truce. Lebanon: 2,659 killed.',
