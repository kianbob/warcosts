...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 57 — ARAGHCHI MEETS PAKISTAN PM — LAYS OUT DEMANDS — DENIES DIRECT US TALKS — TEHRAN FLIGHTS RESUME — ISRAEL KILLS 4+ IN LEBANON DESPITE CEASEFIRE — OIL $105',
  description: 'Operation Epic Fury Day 57: Iran FM Araghchi meets Pakistan PM Sharif for ~20 hours of talks, lays out demands, denies direct talks with US. Departs for Oman, may return Sunday. Witkoff and Kushner heading to Islamabad. Tehran commercial flights resume for first time since war began. Pezeshkian urges electricity conservation — infrastructure destroyed. Israel kills 4+ in Lebanon despite 3-week ceasefire. UK/Finland condemn journalist killing. CENTCOM: 34 ships turned back. Brent ~$105. HRANA: 1,701 civilians unchanged. Lebanon: 2,454 killed. US: 15 KIA, 538 wounded.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 57: Iran FM meets Pakistan PM — lays out demands, denies direct US talks. Tehran flights resume. Israel kills 4+ in Lebanon despite ceasefire. Witkoff/Kushner heading to Islamabad. Oil $105. Lebanon: 2,454 killed.',
