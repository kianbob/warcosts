...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 61 — PENTAGON: WAR COSTS $25 BILLION — HEGSETH GRILLED BY CONGRESS — TRUMP: IRAN "BETTER GET SMART SOON" — RIAL RECORD LOW 1.8M/$1 — OIL SURGES TO $114-117 — ISRAEL KILLS 5 IN LEBANON DOUBLE-TAP — $1.5T DEFENSE BUDGET — GAS $4.18',
  description: 'Operation Epic Fury Day 61: Pentagon reveals war has cost $25 billion — first official estimate. Hegseth testifies before Congress for first time since war began. Trump warns Iran to "get smart soon." Iran rial hits record low 1.8M to $1. Oil surges — Brent $114-117. Israeli double-tap strike kills 5 in Lebanon including 3 rescue workers. Pentagon seeks record $1.5T defense budget. Gas $4.18/gallon. Budget airlines seek $2.5B bailout. 1.24M face food insecurity in Lebanon. HRANA: 1,701 civilians unchanged. US: 15 KIA, 538 wounded. Lebanon: 2,509+ killed.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 61: Pentagon reveals $25B war cost. Hegseth grilled by Congress. Trump: Iran "better get smart soon." Rial record low. Oil $114-117. Israel double-tap kills 5 in Lebanon. $1.5T defense budget. Gas $4.18.',
