...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 35',
  description: 'Operation Epic Fury Day 35: F-15E shot down over Iran — pilot rescued, WSO missing. A-10 also hit. 7 manned aircraft lost. Trump strikes Tehran bridge, Pasteur Institute. HRANA: 3,519+ killed (1,607 civilians, 244+ children). Oil $112/bbl. Pentagon requests $1.1T budget. No ceasefire.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 35: F-15E shot down over Iran. 7 manned aircraft lost. Trump strikes Tehran bridge, Pasteur Institute. HRANA: 3,519+ killed. Oil $112/bbl. Pentagon requests $1.1T. No ceasefire.',
...
const timeline = [
  ...
  { date: 'Apr 3-4 (Day 35)', event: 'F-15E STRIKE EAGLE SHOT DOWN — WSO MISSING: F-15E Strike Eagle from the 494th Fighter Squadron shot down over western Iran by Iranian air defenses. Pilot rescued via Combat Search and Rescue (CSAR). Weapons Systems Officer (WSO) still missing — Iran says "search for missing pilot still ongoing with full force." A-10 Warthog also hit by Iranian air defenses in separate incident. 7 total manned aircraft lost in the war. 16+ MQ-9 Reaper drones lost. Italy sends naval forces to Gulf — expanding coalition. Syria reports explosions in Damascus. Pentagon requests $1.1 TRILLION defense budget plus $350B in reconciliation — largest military budget request in history. HRANA cumulative: 3,519+ killed (1,607 civilians, 244+ children). Lebanon: 1,345+ killed. Brent crude $112.42. No ceasefire. Day 35.' },
]
...
const whoLoses = [
  ...
  { who: 'American Troops', how: '15 US troops dead by Day 35. 300+ wounded (CENTCOM). 7 manned aircraft lost — including F-15E Strike Eagle shot down over western Iran (Day 35, pilot rescued, WSO missing), A-10 Warthog hit same day. 16+ MQ-9 Reaper drones destroyed. 52,000+ deployed. Russia providing Iran with real-time intelligence on US positions. Pentagon requests $1.1T defense budget + $350B reconciliation. Troops are in harm\'s way for a war Congress never authorized.' },
  ...
  { who: 'Iranian Civilians', how: 'HRANA (independent): 3,519+ killed — 1,607 civilians (244+ children), 3,229+ wounded, 1M+ displaced by Day 35. Victims range from 8 months to 88 years old. Pasteur Institute (leading public health institution) destroyed Day 34. Tehran highway bridge struck. 55 healthcare workers wounded, 11 killed. 25 hospitals damaged, 9 out of service. 3.2 MILLION Iranians displaced (UNHCR). 13,000+ strikes conducted (CENTCOM). Trump vows to take Iran "back to the Stone Ages." Iran offline for 35 days. Food distribution disrupted. The war has consolidated military control over Iran — the exact opposite of the stated US goal.' },
