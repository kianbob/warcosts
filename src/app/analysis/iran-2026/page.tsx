...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 32',
  description: 'Operation Epic Fury Day 32: Hegseth says lowest enemy fire in 24 hours. Oil surges to $118/bbl — record 59% monthly gain. Kuwaiti tanker hit off Dubai. Trump tells allies "Go get your own oil." Iran rejects ceasefire, imposes Hormuz tolls. 13,000+ targets struck. US gas hits $4/gal. 15 US troops killed, 303+ wounded. HRANA: 3,461+ killed in Iran. Lebanon: 1,200+ killed. No ceasefire.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 32: Oil hits $118 — record monthly surge. Kuwaiti tanker hit off Dubai. Hegseth: lowest enemy fire yet. 13,000+ targets struck. Iran rejects ceasefire, imposes Hormuz tolls. Gas hits $4/gal. No ceasefire.',
...
const whoLoses = [
  ...
  { who: 'American Troops', how: '15 US troops dead by Day 30 — 6 from Iranian drone strike on Kuwait port, 6 in KC-135 refueling crash in Iraq, others in combat operations. 303+ wounded (CENTCOM). A dozen MQ-9 Reaper drones destroyed. 52,000+ deployed — USS Boxer with 2,200+ Marines departed San Diego (Mar 20), on top of 2,500 Marines (31st MEU + USS Tripoli) already ordered from Japan. A US F-35 made an emergency landing after combat over Iran — possibly struck by Iranian fire. Saudi base attack wounded multiple troops. Russia providing Iran with real-time intelligence on US positions (WaPo, NYT, CNN, NBC). Poland evacuates all troops from Iraq. CIA says war will take 4-6 weeks. Pentagon demands $200 BILLION. MBS secretly pushing Trump to continue. Troops are in harm\'s way for a war Congress never authorized — while Saudi Arabia lobbies from the sidelines.' },
  ...
  { who: 'Iranian Civilians', how: 'HRANA (independent): 3,461+ killed — 1,551 civilians (228+ children), 3,229+ wounded, 1M+ displaced by Day 30. Victims range from 8 months to 88 years old. 55 healthcare workers wounded, 11 killed. 25 hospitals damaged, 9 out of service. 3.2 MILLION Iranians displaced (UNHCR). 12,000+ strikes conducted (CENTCOM). Bandar Khamir port bombed Mar 29. IUST Physics Dept struck — nuclear scientist killed. Iran offline for 30 days. Food distribution disrupted. Iran\'s new top security chief is a hardline IRGC general — the war has consolidated military control over Iran, the exact opposite of the stated US goal. Many of these people were protesting their own government just weeks ago.' },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Mar 31, 2026 — Day 32</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 32: 15 US troops dead, 303+ wounded. Iran: 3,461+ killed (HRANA — 1,551 civilians, 228+ children). Lebanon: 1,200+ killed.
