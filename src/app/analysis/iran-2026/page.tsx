...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 48 — ISRAEL-LEBANON CEASEFIRE — SENATE KILLS WAR POWERS AGAIN — IEA: 6 WEEKS OF JET FUEL LEFT',
  description: 'Operation Epic Fury Day 48: Israel and Lebanon agree to 10-day ceasefire starting 5 PM ET (AP/Trump). Senate rejects War Powers resolution 47-52 (4th time) and arms sales halt 40-59. USS Gerald R. Ford breaks post-Vietnam deployment record at 295 days. IEA warns Europe has ~6 weeks of jet fuel left. 60-day War Powers deadline looms end of April — GOP senators eyeing AUMF vote. Lebanon: 2,124 killed. HRANA: 1,701 Iranian civilians (254 children). Ceasefire expires Apr 21 — 5 days left.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 48: Israel-Lebanon 10-day ceasefire announced. Senate kills War Powers resolution 47-52 (4th time). USS Ford breaks post-Vietnam deployment record. IEA: 6 weeks of jet fuel left in Europe. 60-day deadline looms. Lebanon: 2,124 killed. Ceasefire expires in 5 days.',
