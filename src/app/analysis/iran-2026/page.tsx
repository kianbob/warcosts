...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 56 — HEGSETH: BLOCKADE "GROWING AND GOING GLOBAL" — LEBANON CEASEFIRE EXTENDED 3 WEEKS — 3RD CARRIER ARRIVES — 34 SHIPS TURNED BACK — IRAN FM HEADING TO ISLAMABAD — PENTAGON THREATENS NATO ALLIES — US MUNITIONS DEPLETED — OIL $107',
  description: 'Operation Epic Fury Day 56: Hegseth says blockade "growing and going global," will last "as long as it takes." 3rd aircraft carrier (USS George HW Bush) arrives. CENTCOM: 34 ships turned back. 2 dark fleet ships seized in Indo-Pacific. Israel-Lebanon ceasefire extended 3 weeks — Hezbollah calls it "meaningless." Iran FM Araghchi heading to Islamabad. Pentagon threatens NATO allies including suspending Spain. WSJ: US used 1,000+ Tomahawks, threatens Taiwan readiness. IEA: "biggest energy security threat in history." Brent crude ~$107. Lebanon: 2,454 killed. US: 15 KIA, 538 wounded.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 56: Hegseth says blockade "growing and going global." 3rd carrier arrives. 34 ships turned back. Lebanon ceasefire extended 3 weeks — Hezbollah: "meaningless." Iran FM heading to Islamabad. Pentagon threatens NATO allies. US munitions depleted. Oil $107. Lebanon: 2,454 killed.',
