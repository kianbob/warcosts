...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 41 — CEASEFIRE TEETERING',
  description: 'Operation Epic Fury Day 41: Ceasefire teetering. Israel\'s deadliest Lebanon attack (254 killed) threatens truce. Iran RE-CLOSES Hormuz over Lebanon strikes. Ghalibaf: ceasefire "unreasonable." EU demands Lebanon included. Oil rebounds to $98/bbl. VP Vance heads to Islamabad for Saturday talks. 5,000+ killed. 1,665+ Iranian civilians.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 41: Ceasefire teetering. Israel\'s deadliest Lebanon attack (254 killed Apr 8) threatens truce. Iran re-closes Hormuz. EU demands Lebanon included. Oil $98/bbl. Vance heads to Islamabad Saturday. 5,000+ killed. 1,665+ Iranian civilians.',
...
const whoLoses = [
  ...
  { who: 'American Troops', how: '13 US troops killed in action by Day 40. 520+ wounded (CENTCOM/Intercept). Both F-15E crew rescued after harrowing 2-day CSAR inside Iran (170+ aircraft, hundreds of troops). 7 manned aircraft lost. 16+ MQ-9 Reaper drones destroyed. 52,000+ deployed. CEASEFIRE announced Day 39 — but missiles still flying after it took effect, and Israel escalated in Lebanon on Day 40 with heaviest strikes of the war. Pentagon requests $1.1T defense budget + $350B reconciliation. Additional US forces remaining in region during truce. Troops remain in harm\'s way for a war Congress never authorized.' },
  ...
  { who: 'Iranian Civilians', how: 'Reuters: 5,000+ killed across nearly a dozen countries by Day 40. HRANA (independent): 1,665+ civilians killed in Iran including 244 children (as of Apr 7). CEASEFIRE announced Day 39 — 2-week pause, Pakistan-mediated talks in Islamabad starting Apr 10. But missiles were STILL launched from Iran after ceasefire took effect. Israel escalated in Lebanon on Day 40 with heaviest strikes of the war — Iran considering backing out of ceasefire entirely (Tasnim). IAEA: one strike 250 feet from operating Bushehr reactor — "could cause severe radiological accident." 3.2M+ Iranians displaced (UNHCR). 800+ US strikes on Iran on Day 39 alone (Hegseth). Only 2 ships crossed Hormuz on Day 40; 400+ vessels still stranded. Iran\'s 10-point counterproposal demands non-aggression pact, sanctions lifted, enrichment acceptance, US base withdrawal, war compensation — Trump says "no enrichment." The war consolidated military control over Iran — the exact opposite of the stated US goal.' },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-amber-700 text-amber-100">🕊️ CEASEFIRE TEETERING — Updated Apr 10, 2026 — Day 41</span>
        </div>
