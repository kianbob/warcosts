...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 55 — TRUMP ORDERS NAVY TO "SHOOT AND KILL" IRANIAN BOATS LAYING MINES — IRGC SEIZES 2 MORE SHIPS IN HORMUZ — US SEIZES TANKER MAJESTIC X — 31 SHIPS TURNED BACK — SENATE KILLS WAR POWERS AGAIN (5TH TIME) — OIL $103 — ISRAEL: "WAITING FOR GREEN LIGHT" TO RESUME WAR',
  description: 'Operation Epic Fury Day 55: Trump orders Navy to "SHOOT AND KILL" any Iranian boats laying mines in Strait of Hormuz. IRGC seizes 2 foreign vessels in Hormuz, fires on a third. US seizes tanker Majestic X in Indian Ocean — second seizure this week. CENTCOM: 31 ships turned back under blockade. Ghalibaf: Hormuz will NOT reopen while blockade remains. Israel defense minister Katz: Israel "waiting for green light" from US to resume war. Senate kills 5th War Powers resolution 46-51. Navy Secretary Phelan fired — 34th senior official removed under Trump. Brent crude ~$103/barrel. Lebanese journalist Amal Khalil killed by Israeli airstrike despite ceasefire. Lebanon: 2,454 killed. US: 13 KIA, 400 wounded. No talks scheduled.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 55: Trump orders Navy to shoot Iranian boats laying mines in Hormuz. IRGC seizes 2 ships, fires on third. US seizes tanker Majestic X. Israel "waiting for green light" to resume war. Senate kills 5th War Powers vote. Oil $103. Lebanon: 2,454 killed.',
