...
export const metadata: Metadata = {
  ...
  description: 'Operation Epic Fury Day 23: Trump issues 48-HOUR ULTIMATUM — threatens to "obliterate" Iran\'s power plants if Hormuz not reopened. Iran threatens "irreversible damage" to regional energy. Iranian missiles break through Israeli defenses at DIMONA — 100+ wounded near nuclear site. Iran death toll tops 1,500 (state media) / 3,230 (HRANA). Saudi expels Iranian diplomats. Turkey mediates. Oil surges to $112/barrel. Most Americans say war "not going well." Who benefits?',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 23: Trump\'s 48-hour Hormuz ultimatum. Iran threatens energy apocalypse. Missiles hit Dimona. No congressional approval. Who benefits?',
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-stone-700 text-stone-300">Updated Mar 22, 2026 — Day 23</span>
        </div>
        ...
        <p className="text-stone-400 text-lg mb-4">
          ...
          By Day 23: 13 US troops dead, 200+ wounded. 1,500+ killed in Iran (state media), 3,230+ (HRANA — 1,406 civilians, 210+ children), 20,984 injured.
          1,000+ killed in Lebanon, 2,600+ wounded, 1 million+ displaced.
          3.2 million Iranians displaced. 8,000+ targets struck in Iran alone, 130 vessels destroyed.
          The Pentagon demands $200 BILLION from Congress. Trump issues 48-HOUR ULTIMATUM: threatens to &ldquo;obliterate&rdquo; Iran&apos;s power plants
          if Hormuz not reopened. Iran threatens &ldquo;irreversible damage&rdquo; to regional energy infrastructure.
          Iranian missiles break through Israeli defenses at Dimona — 100+ wounded near nuclear site. Saudi Arabia expels Iranian diplomats.
          Turkey launches diplomatic push. Oil surges to $112/barrel. Most Americans say war &ldquo;not going well.&rdquo; No exit strategy. No end in sight.
        </p>
