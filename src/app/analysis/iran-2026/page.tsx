...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 45 — US BLOCKADE OF IRAN BEGINS',
  description: 'Operation Epic Fury Day 45: Islamabad peace talks COLLAPSE after 21 hours. Trump orders US naval BLOCKADE of Iranian ports — takes effect Apr 13. Oil surges 7% to $102/bbl. Europe refuses to participate. Lebanon: 2,020+ killed. HRANA: 1,701 Iranian civilians (254 children). Ceasefire hanging by a thread.',
  openGraph: {
