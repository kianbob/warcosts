...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 43 — HISTORIC TALKS IN ISLAMABAD',
  description: 'Operation Epic Fury Day 43: VP Vance meets Iran\'s Ghalibaf face-to-face in Islamabad — highest-level US-Iran contact since 1979. Pakistan mediating. Ceasefire fragile. Hormuz still closed (19 ships since truce). Lebanon: 1,953 killed. HRANA: 1,701 Iranian civilians (254 children). Oil ~$98/bbl.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 43: Historic Vance-Ghalibaf meeting in Islamabad — highest-level US-Iran contact since 1979. Ceasefire fragile. Hormuz still closed. Lebanon: 1,953 killed. Oil ~$98/bbl. 5,000+ killed across region.',
