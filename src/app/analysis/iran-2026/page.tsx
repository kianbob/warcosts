...
export const metadata: Metadata = {
  title: 'Whose War Is This? The Iran Conflict Nobody Asked For | Day 46 — BLOCKADE IN EFFECT, TALKS MAY RESUME',
  description: 'Operation Epic Fury Day 46: US blockade of Iranian ports — first full day, no enforcement incidents. Oil falls below $100 on hopes of resumed Islamabad talks. IMF warns of recession. Italy suspends Israel defense pact. France-UK Hormuz summit Friday. Lebanon: 2,020+ killed. HRANA: 1,701 Iranian civilians (254 children). Ceasefire holding — 1 week left.',
  openGraph: {
    title: 'Whose War Is This? The Iran Conflict Nobody Asked For',
    description: 'Day 45: Peace talks collapse. US naval blockade of Iran begins. Oil surges to $102. Europe refuses to participate. Lebanon: 2,020+ killed. 5,000+ killed across region. Ceasefire crumbling.',
...
const whoLoses = [
  ...
  { who: 'American Troops', how: '13 US troops killed in action by Day 43. 520+ wounded (CENTCOM/Intercept). Both F-15E crew rescued after harrowing 2-day CSAR inside Iran (170+ aircraft, hundreds of troops). 7 manned aircraft lost. 16+ MQ-9 Reaper drones destroyed. 52,000+ deployed. CEASEFIRE announced Day 39 — VP Vance now in Islamabad for historic face-to-face talks with Iran (highest-level since 1979). But Israel continues striking Lebanon; Hormuz still closed; mines still in waterway. Pentagon requests $1.1T defense budget + $350B reconciliation. Additional US forces remaining in region during truce. Troops remain in harm\'s way for a war Congress never authorized.' },
  ...
  { who: 'Iranian Civilians', how: 'Reuters: 5,000+ killed across nearly a dozen countries by Day 40. HRANA (independent): 1,701+ civilians killed in Iran including 254 children (as of Apr 9). CEASEFIRE announced Day 39 — VP Vance now in Islamabad for historic face-to-face talks with Iran\'s Ghalibaf (highest-level US-Iran meeting since 1979). No new Iranian casualties since ceasefire took effect. But Israel escalated massively in Lebanon on Day 40 — deadliest day: 300+ killed in 10 minutes. IAEA: one strike 250 feet from operating Bushehr reactor — "could cause severe radiological accident." 3.2M+ Iranians displaced (UNHCR). Hormuz still closed — only 19 ships since ceasefire; Iran can\'t even locate all mines it laid (NYT). Iran\'s 10-point counterproposal demands non-aggression pact, sanctions lifted, enrichment acceptance, US base withdrawal, war compensation — Trump says "no enrichment." The war consolidated military control over Iran — the exact opposite of the stated US goal.' },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-900 text-white rounded-xl p-8 md:p-12 mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full bg-amber-700 text-amber-100">🕊️ HISTORIC TALKS IN ISLAMABAD — Updated Apr 12, 2026 — Day 43</span>
        </div>
