...
export default function IranCostPerSecondPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <RelatedArticles articles={[{"slug":"49-days-in","title":"49 Days In: Iran War Costs","desc":"What the Iran war has cost after 49 days."},{"slug":"iran-2026","title":"Iran 2026","desc":"The war nobody asked for."},{"slug":"iran-civilian-cost","title":"Iran Civilian Cost","desc":"Schools, hospitals, bazaars destroyed."},{"slug":"iran-day-by-day","title":"Iran Day-by-Day Timeline","desc":"The war unfolding in real time."}]} />
      <BackToTop />
