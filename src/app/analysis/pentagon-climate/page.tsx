...
const militaryEmissionsByBranch = [
  {
    branch: 'U.S. Air Force',
    annualCO2: '23.8 million MT',
    fuelConsumption: '2.4 billion gallons',
    primarySources: 'Fighter jets, cargo aircraft, bombers, tanker aircraft',
    majorBases: 'Nellis AFB (Nevada), Edwards AFB (California), MacDill AFB (Florida)',
    emissions: '42% of total DOD emissions',
    notes: 'Single largest institutional consumer of jet fuel globally. F-35 burns 5,600 gallons per flight hour.',
  },
  {
    branch: 'U.S. Navy',
    annualCO2: '18.9 million MT',
    fuelConsumption: '1.8 billion gallons',
    primarySources: 'Aircraft carriers, destroyers, submarines, naval aviation',
    majorBases: 'Naval Station Norfolk (Virginia), NAS Pensacola (Florida), Pearl Harbor (Hawaii)',
    emissions: '34% of total DOD emissions',
    notes: 'Nuclear carriers consume 150,000 gallons of jet fuel per day for aircraft operations alone.',
  },
  {
    branch: 'U.S. Army',
    annualCO2: '9.2 million MT',
    fuelConsumption: '900 million gallons',
    primarySources: 'Vehicles, generators, helicopters, base operations',
    majorBases: 'Fort Bragg (North Carolina), Fort Hood (Texas), Fort Campbell (Kentucky)',
    emissions: '16% of total DOD emissions',
    notes: 'Largest ground vehicle fleet. M1 Abrams tank gets 0.6 MPG, burns 10 gallons per mile.',
  },
  {
    branch: 'U.S. Marines',
    annualCO2: '2.8 million MT',
    fuelConsumption: '280 million gallons',
    primarySources: 'Aircraft, amphibious vehicles, base operations',
    majorBases: 'Camp Pendleton (California), Camp Lejeune (North Carolina), Quantico (Virginia)',
    emissions: '5% of total DOD emissions',
    notes: 'Highest emissions per capita due to aviation and amphibious operations intensity.',
  },
  {
    branch: 'Space Force',
    annualCO2: '1.3 million MT',
    fuelConsumption: '180 million gallons',
    primarySources: 'Rocket launches, satellite operations, space surveillance',
    majorBases: 'Vandenberg SFB (California), Patrick SFB (Florida), Schriever SFB (Colorado)',
    emissions: '3% of total DOD emissions',
    notes: 'Newest branch but rapidly expanding launch operations. Single heavy rocket launch = 300 tons CO₂.',
  },
]

const pfasContaminationSites = [
  {
    installation: 'Wright-Patterson Air Force Base',
    state: 'Ohio',
    contaminationType: 'PFAS, TCE, chromium',
    affectedPopulation: '85,000+ residents',
    contaminationLevel: 'Up to 52,000 ppt PFOA (EPA advisory: 70 ppt)',
    healthImpacts: 'Increased cancer rates, liver problems, decreased fertility',
    cleanupCost: '$2.1 billion estimated',
    status: 'Ongoing since 1994. Settlement: $7.2M in 2020.',
  },
  {
    installation: 'Camp Lejeune',
    state: 'North Carolina',
    contaminationType: 'TCE, PCE, benzene, vinyl chloride',
    affectedPopulation: '1+ million service members and families (1953-1987)',
    contaminationLevel: 'TCE up to 1,400x safe levels',
    healthImpacts: '15+ cancers, birth defects, Parkinson\'s disease',
    cleanupCost: '$34+ billion in disability payments authorized',
    status: 'PACT Act (2022) provides healthcare and compensation to victims.',
  },
  {
    installation: 'McGuire Air Force Base',
    state: 'New Jersey',
    contaminationType: 'PFAS, jet fuel, TCE',
    affectedPopulation: '40,000+ residents in surrounding area',
    contaminationLevel: 'PFAS in drinking water up to 890 ppt',
    healthImpacts: 'Cancer clusters, kidney disease, immune system problems',
    cleanupCost: '$180 million allocated',
    status: 'Temporary water treatment systems installed 2018.',
  },
  {
    installation: 'Malmstrom Air Force Base',
    state: 'Montana',
    contaminationType: 'PFAS, fuel contamination',
    affectedPopulation: '15,000+ base personnel and nearby residents',
    contaminationLevel: 'PFAS up to 58,000 ppt in groundwater',
    healthImpacts: 'Elevated cancer rates among firefighters and maintenance personnel',
    cleanupCost: '$95 million proposed',
    status: 'Investigation ongoing. Alternative water sources provided.',
  },
  {
    installation: 'Naval Air Station Oceana',
    state: 'Virginia',
    contaminationType: 'PFAS, jet fuel, metals',
    affectedPopulation: '25,000+ military families and civilian neighbors',
    contaminationLevel: 'PFAS detected in drinking water and soil',
    healthImpacts: 'Higher rates of thyroid problems, reproductive issues',
    cleanupCost: '$240 million estimated',
    status: 'Water filtration systems installed 2019.',
  },
  {
    installation: 'Davis-Monthan Air Force Base',
    state: 'Arizona',
    contaminationType: 'PFAS, TCE, fuel hydrocarbons',
    affectedPopulation: '12,000+ base personnel, surrounding Tucson area',
    contaminationLevel: 'TCE in groundwater up to 390x EPA limit',
    healthImpacts: 'Kidney cancer, liver damage, birth defects',
    cleanupCost: '$165 million allocated',
    status: 'Groundwater treatment operational since 2012.',
  },
]
...
const burnPitData = [
  {
    ...
    period: '2003-2011',
    wasteTypes: 'Medical waste, human waste, fuel, plastic, electronics, batteries, tires',
    exposedPersonnel: '180,000+ service members',
    burnPitSize: '10+ acres of continuous burning',
    healthEffects: 'Respiratory illness, cancers, neurological problems, autoimmune diseases',
    chemicalsDetected: 'Dioxins, particulate matter, hydrogen sulfide, carbon monoxide',
    status: 'PACT Act (2022) provides presumptive care for 23 conditions.',
  },
  {
    location: 'Bagram Airfield, Afghanistan',
    period: '2001-2021',
    wasteTypes: 'All base waste including medical, chemical, and human waste',
    exposedPersonnel: '200,000+ service members over 20 years',
    burnPitSize: '6 acres of active burning',
    healthEffects: 'Constrictive bronchiolitis, rare cancers, reproductive problems',
    chemicalsDetected: 'Heavy metals, volatile organic compounds, particulates',
    status: 'Site abandoned to Taliban 2021. No cleanup performed.',
  },
  {
    location: 'Ali Al Salem Air Base, Kuwait',
    period: '2003-2021',
    wasteTypes: 'Fuel, plastic, electronic waste, medical waste',
    exposedPersonnel: '75,000+ service members',
    burnPitSize: '8 acres',
    healthEffects: 'Asthma, chronic bronchitis, sleep apnea, gastrointestinal problems',
    chemicalsDetected: 'Benzene, acetone, dioxins, methylene chloride',
    status: 'Burn pit operations ceased 2021. Health monitoring ongoing.',
  },
  {
    location: 'Camp Victory, Iraq',
    period: '2003-2011',
    wasteTypes: 'All base waste including human waste, medical waste, electronics',
    exposedPersonnel: '150,000+ service members',
    burnPitSize: '12 acres',
    healthEffects: 'Lung disease, cancers, heart problems, mental health issues',
    chemicalsDetected: 'Particulate matter 2.5, sulfur compounds, heavy metals',
    status: 'Base closed 2011. Veterans eligible for PACT Act benefits.',
  },
  {
    location: 'Kandahar Airfield, Afghanistan',
    period: '2001-2021',
    wasteTypes: 'Medical waste, batteries, fuel, plastics, human waste',
    exposedPersonnel: '125,000+ service members',
    burnPitSize: '5 acres',
    healthEffects: 'Respiratory disease, rare brain cancers, autoimmune disorders',
    chemicalsDetected: 'Dioxins, furans, volatile organic compounds',
    status: 'Site evacuated 2021. Extensive PACT Act claims filed.',
  },
]

const climateImpactOnBases = [
  {
    base: 'Naval Station Norfolk',
    state: 'Virginia',
    threat: 'Sea level rise, flooding',
    impact: 'Flooding increases 50% by 2030, 100% by 2050',
    cost: '$1.2 billion in infrastructure at risk',
    adaptationMeasures: 'Seawalls, elevated buildings, flood barriers',
    status: 'Home to world\'s largest naval base. Critical national security infrastructure at risk.',
  },
  {
    base: 'Eglin Air Force Base',
    state: 'Florida',
    threat: 'Hurricane intensity, storm surge',
    impact: 'Category 5 hurricanes projected to increase 300%',
    cost: '$3.8 billion in assets exposed to storm damage',
    adaptationMeasures: 'Hardened hangars, elevated fuel storage, backup power',
    status: 'F-35 training center. Aircraft worth $80M each vulnerable to storms.',
  },
  {
    base: 'Fort Irwin',
    state: 'California',
    threat: 'Extreme heat, drought',
    impact: 'Training days lost: 15 per year by 2030, 45 per year by 2050',
    cost: '$200M in additional cooling, water infrastructure needed',
    adaptationMeasures: 'Solar cooling, water recycling, modified training schedules',
    status: 'Primary desert warfare training center. Critical for military readiness.',
  },
  {
    base: 'Joint Base Elmendorf-Richardson',
    state: 'Alaska',
    threat: 'Permafrost thaw, infrastructure damage',
    impact: 'Runways, buildings, fuel systems compromised by thaw',
    cost: '$800M infrastructure replacement needed',
    adaptationMeasures: 'Foundation reinforcement, facility relocation, cooling systems',
    status: 'Arctic defense headquarters. Strategic position threatened by warming.',
  },
  {
    base: 'Offutt Air Force Base',
    state: 'Nebraska',
    threat: 'River flooding, extreme weather',
    impact: '2019 flood caused $420M damage. Frequency increasing.',
    cost: '$1.1 billion flood protection system needed',
    adaptationMeasures: 'Levees, facility elevation, improved drainage',
    status: 'Strategic Command headquarters. Nuclear command authority at risk.',
  },
]

const militaryWasteStats = [
  {
    category: 'Hazardous Waste Generation',
    amount: '750,000 tons annually',
    details: 'More than the top 5 US chemical companies combined',
    source: 'EPA Toxics Release Inventory',
  },
  {
    category: 'PFAS Contaminated Sites',
    amount: '700+ installations',
    details: 'Forever chemicals in drinking water at majority of US bases',
    source: 'DOD PFAS Task Force Report (2022)',
  },
  {
    category: 'Superfund Sites',
    amount: '141 military sites',
    details: 'More than any other single entity in the US',
    source: 'EPA National Priorities List',
  },
  {
    category: 'Unexploded Ordnance Area',
    amount: '10 million acres',
    details: 'Area larger than Maryland and Delaware combined',
    source: 'DOD UXO Program',
  },
  {
    category: 'Cleanup Cost Estimate',
    amount: '$50+ billion',
    details: 'Estimated cost to clean up all military contamination',
    source: 'GAO Military Base Cleanup Report',
  },
  {
    category: 'Annual Waste Treatment',
    amount: '$3.2 billion',
    details: 'DOD spending on environmental remediation annually',
    source: 'DOD Environmental Budget',
  },
]
