...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Iran controls it. Day 24: Trump POSTPONES power plant ultimatum 5 days — claims "very strong talks." Iran disputes: "a ploy to buy time." Iran warns Hormuz "completely closed" if power plants hit. Oman brokers safe passage arrangements. Oil drops to ~$100 on talk of talks. IEA: "worse than 1973 and 1979 combined." The energy war reaches a tipping point.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
