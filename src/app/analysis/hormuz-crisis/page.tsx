...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Iran controls it. Day 40: Ceasefire fracturing — only 2 ships crossed Hormuz; 400+ stranded. Oil crashes 15% to $95/bbl but Israel pounds Lebanon with heaviest strikes of war. Iran considers backing out. Iran\'s 10-point demands include Hormuz tolls as permanent revenue. Talks Apr 10 in Islamabad.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
