...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Day 52: USS Spruance seizes Iranian cargo ship Touska in Gulf of Oman — Marines searching 5,000 containers. Iran calls it piracy. Only 3 ships crossed Hormuz Monday (pre-war: 120+/day). Both sides now heading to Islamabad talks. Oil ~$95-96/bbl. Ceasefire expires TOMORROW Apr 21.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
...
const historicalThreats = [
  ...
  { year: 'Apr 20, 2026', event: 'USS Spruance seizes Touska — Hormuz at standstill — 3 ships', details: 'USS Spruance (DDG-111) fires on and seizes Iranian-flagged cargo ship M/V Touska in the Gulf of Oman after it attempts to evade the naval blockade (NYT/NPR/CNN/CNBC). Marines from USS Tripoli (LHA-7) rappel onto vessel — now searching up to 5,000 containers. Iran\'s armed forces call it "piracy" and warn of "swift retaliation" (Tasnim). CENTCOM: US has turned back 27 ships total. Only 3 ships crossed Strait of Hormuz on Monday (Kpler) — down from 24 on Saturday when Iran briefly opened it, and just 1 on Sunday. Pre-war average: 120+ vessels/day. The three ships that crossed: Nova Crest (Barbados), Starway (Liberia), Axon 1 (Gambia). At least 20 vessels attacked in recent weeks (IMO). Most shipping companies say situation too precarious. Despite seizure, both sides now planning to send delegations to Islamabad — Vance departing Tuesday, Ghalibaf will attend if Vance does. Oil jumps ~5-6% to ~$95-96/bbl (Brent). Energy Sec Wright: gas prices "could remain elevated for months." The Touska seizure is the most aggressive US blockade enforcement action yet — and the Hormuz standstill shows the strait remains effectively closed despite the ceasefire. Day 52.' },
]
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-800 rounded-lg p-6 my-6">
        ...
        <p className="text-stone-300 text-sm mt-4">
          <strong>Current status (as of Apr 20, 2026 — Day 52):</strong> USS Spruance seizes Iranian cargo ship Touska in Gulf of Oman — Marines searching 5,000 containers. Iran calls it "piracy." Only 3 ships crossed Hormuz Monday (pre-war: 120+/day). Hundreds of vessels stranded. US naval blockade of Iranian ports continues (27 ships turned back). Oil ~$95-96/bbl. Both sides heading to Islamabad for talks. Ceasefire expires TOMORROW. 
