...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Iran controls it. Day 32: Kuwaiti tanker hit off Dubai. Oil surges to $118/bbl — record 59% monthly gain. Iran imposes formal toll regime on Hormuz shipping. Fewer than 150 tankers traversed strait in all of March. US gas hits $4/gallon. Trump tells allies "Go get your own oil." Pentagon preparing ground operations on Kharg Island. IMF warns of global slowdown. China confirms only 3 ships through. The blockade tightens.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
