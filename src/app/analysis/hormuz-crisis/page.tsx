...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Day 49: Iran FM declares Hormuz "completely open" for ceasefire duration — oil CRASHES 13% to ~$86/bbl. Trump claims Iran agreed to never close Hormuz again and is removing sea mines. US naval blockade of Iranian ports remains. Lebanon ceasefire Day 1. Progress on MOU. Ceasefire expires Apr 21 — 4 days left.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
