...
const historicalThreats = [
  ...
  { year: 'Apr 25, 2026', event: 'Araghchi meets Pakistan PM — lays out demands — denies direct US talks — Tehran flights resume', details: 'Iran FM Araghchi meets Pakistan PM Sharif and Army Chief Munir for ~20 hours of talks in Islamabad — lays out Iran\'s demands for ending the war. Araghchi denies direct talks with US, departs for Muscat (Oman), expected back Sunday/Monday. Iran diplomatic source: "will not accept maximalist demands" (Reuters). Witkoff/Kushner heading to Islamabad Saturday. Tehran commercial flights resume for first time since war began — flights to Istanbul, Muscat, Medina (Iran state TV/Flightradar24). CENTCOM: 34 ships turned back (unchanged). Blockade remains in full effect. Oil ~$105/barrel — heading for sharp weekly gain. The diplomatic dance continues through intermediaries while both sides hold their leverage cards. Day 57.' },
  { year: 'Apr 24, 2026', event: 'Hegseth: Blockade "growing and going global" — 3rd carrier arrives — 34 ships turned back', details: 'Hegseth holds Pentagon briefing — says blockade will last "as long as it takes," is "growing and going global." CENTCOM: 34 ships now turned back (up from 31). 2 dark fleet Iranian ships seized in Indo-Pacific. USS George HW Bush strike group arrives — 3 carrier strike groups deployed. Gen. Caine details Touska seizure: 5 warning shots, then 9 disabling rounds into engine room. Marines rappelled from helicopters. Israel-Lebanon ceasefire extended 3 weeks — Hezbollah: "meaningless." Iran FM Araghchi heading to Islamabad. Pentagon threatens suspending Spain from NATO. WSJ: US used 1,000+ Tomahawks — threatens Taiwan readiness. IEA: "biggest energy security threat in history." Panama Canal prices surge $4M extra. Oil ~$107/barrel. Day 56.' },
  { year: 'May 9, 2026', event: 'UK deploys HMS Dragon — 58 ships turned back — Kharg Island oil spill — no breakthrough', details: 'UK Royal Navy deploys HMS Dragon to Middle East to "pre-position" for multinational Hormuz freedom-of-navigation mission led by UK and France (UK MOD). Coalition won\'t start until sustainable ceasefire confirmed. CENTCOM: 58 commercial vessels now turned back under blockade (up 1), 4 vessels disabled. Both US and Iran say ceasefire is "holding" despite exchanging fire (NYT). KHARG ISLAND OIL SPILL: Satellite imagery shows 27-square-mile oil slick from Kharg Island — Iran\'s main crude terminal — an estimated 80,000 barrels spilled (AP/Windward AI). Could reach UAE/Qatar/Saudi shores in 2 weeks. Pentagon declines comment. Greenpeace: likely to dissipate offshore. ASEAN adopts crisis contingency plan for the war\'s energy impact. Oil: Brent $101.29 (+1% Friday). Day 71.' },
  { year: 'May 10, 2026', event: 'Trump rejects Iran proposal — drones hit Gulf — first Qatari LNG transits Hormuz', details: 'Trump rejects Iran peace plan as "TOTALLY UNACCEPTABLE" — oil jumps $3 on rejection (Reuters/NYT). Iran\'s response demanded: end to war, lift blockade, release frozen assets, sovereignty over Hormuz (Reuters/Tasnim). WSJ: Iran offered to dilute enriched uranium. Hostile drones hit UAE, Kuwait (both neutralized). Cargo vessel SAFESEA NEHA struck off Qatar — fire onboard (UKMTO). FIRST Qatari LNG tanker Al Kharaitiyat passes through Hormuz to Pakistan — approved by Iran as confidence-building measure with mediators (Kpler/Reuters). Panama-flagged bulk carrier also transits Iran-designated route. IRGC: "restraint is over" if tankers attacked (Nournews/CNN). Boxer ARG (5,000 Marines) deploying to join 20-warship blockade force (TWZ). Saudi Aramco Q1 profit up 25% shifting away from Hormuz (AP). Brent ~$104. Day 72.' },
  { year: 'May 15, 2026', event: 'CENTCOM: 75 ships redirected — Cooper testifies 90% of Iran mines destroyed — Xi pledged Hormuz must stay open', details: 'CENTCOM commander Adm. Brad Cooper testifies to Senate Armed Services Committee: US forces have destroyed 90% of Iran\'s inventory of 8,000 naval mines (CBS). Iran\'s capability to stop commerce "dramatically degraded" but threats still "clearly heard by the merchant industry and the insurance industry." US has military options to reopen Hormuz — "decision for policymakers." CENTCOM: 75 commercial ships redirected under blockade (Fox News/CENTCOM). Trump says Xi pledged China won\'t arm Iran and supports Hormuz reopening — but China will continue buying Iranian oil (AP/CNBC/Time). Germany\'s Merz after call with Trump: Iran "must come to the negotiating table now" and open the Strait (Merz/X). Oil: Brent $106.89 (+1.11%), WTI $104.27 (+3.07%). Day 77.' },
  { year: 'May 16, 2026', event: 'USS Ford home — Russia backs China ceasefire call — Pakistan facilitates', details: 'USS Gerald R. Ford returns to Naval Station Norfolk after 11-month deployment — longest since Vietnam era (India Today/CBS). Ford Carrier Strike Group 12 awarded Presidential Unit Citation. Russia backs China\'s call for permanent ceasefire and Hormuz reopening (India Today). Putin-UAE president discuss crisis (Kremlin). Pakistan minister arrives in Tehran to facilitate peace talks. Oil: Brent ~$108-110/bbl. CNBC warns global stockpiles could hit record lows if Hormuz stays closed. Day 78.' },
  { year: 'May 18, 2026', event: 'Trump: "clock is ticking" — US ammo planes land in Israel — Saudi intercepts 3 drones — US ships oil to Australia', details: 'Trump threatens Iran: "clock is ticking... there won\'t be anything left of them" (Truth Social). Dozens of US planes carrying ammunition land in Tel Aviv — raising concerns about potential new strikes (Rediff). Saudi Arabia intercepts 3 drones — no claim of responsibility. NATO/US intelligence assessment: Iran retains at least 60% of missile capability, 90% of underground facilities operational, access to 30/33 Hormuz missile sites (Independent/NYT/NATO sources). Iran\'s "mosquito fleet" of IRGC speedboats maintaining blockade. US now shipping crude to Australia as Hormuz crisis reshapes global oil flows — markets that relied on Gulf producers sourcing from Americas (247 Wall St). Iran stock market reopens — first trading since war began. Oil: Brent $110.08, WTI $106.01. Day 80.' },
  { year: 'May 21, 2026', event: '3 supertankers exit Hormuz with 6M barrels — Hormuz Authority claims UAE waters — Supreme Leader: uranium stays', details: 'Three VLCCs carrying 6 million barrels of crude exit Strait of Hormuz via Iran-designated transit route — headed to Asian markets (Reuters/Kpler). Includes South Korean Universal Winner (2M bbl Kuwaiti crude, loaded March 4) heading to Ulsan, plus 2 Chinese tankers. 20,000 seafarers still stranded on hundreds of ships in Gulf. Traffic averaging ~10 vessels/day vs pre-war 125-140 daily passages (Reuters). Iran\'s "Persian Gulf Strait Authority" declares area of control extends to waters south of UAE\'s Fujairah port — Fujairah hosts oil infrastructure designed to bypass Hormuz (Straits Times/FMT). UAE adviser Gargash slams announcement. Supreme Leader Mojtaba Khamenei: enriched uranium must NOT leave Iran — hardening key US demand (Reuters exclusive). Trump: talks "right on the borderline" — willing to wait "a few days" (Reuters/CNBC). Pakistan army chief Munir heading to Tehran to mediate. Iran reviewing US proposal. Oil: Brent $108.76 — down from $111 yesterday. Day 83.' },
  { year: 'May 20, 2026', event: 'US seizes Iranian-linked oil tanker in Indian Ocean — Trump: Iran has "2-3 days" — Oil $111', details: 'US seizes Iranian-linked oil tanker in Indian Ocean overnight (WSJ via US officials). Trump threatens Iran with "another big hit" — gives "2-3 days" deadline (CNBC/Reuters). Goldman Sachs: every month Hormuz stays closed adds $10/bbl at year-end. Oil: Brent $111.28, WTI $107.77 — both up 50%+ since war began. ING: some shipping activity resumed but flows well below normal — market relying on inventory and alternative supply. Day 82.' },
  { year: 'May 17, 2026', event: 'Drone hits Barakah nuclear plant — stockpile warnings — Gates: can\'t walk away', details: 'Drone strike targets UAE\'s $20 billion Barakah nuclear power plant — fire on perimeter, no radiological release (CBS/UAE/IAEA). Suspicion on Iran. Barakah provides 25% of UAE energy. Former Defense Secretary Gates: US can\'t "walk away" from Iran war — nuclear program "not imminent threat" — only resolution through negotiation (Face the Nation/CBS). Oil: Brent ~$110/bbl. CNBC: global oil stockpiles could hit record lows if Hormuz remains closed. Day 79.' },
  { year: 'May 23-25, 2026', event: 'Deal "largely negotiated" — 1,500 ships waiting — Oil crashes to $98', details: 'Trump claims deal "largely negotiated" — MOU includes 60-day ceasefire extension, Hormuz opens toll-free, Iran can sell oil, US lifts blockade, nuclear talks (AP/Axios/Guardian). Iran would give up 441kg of enriched uranium — Russia offers to take it (AP). Iran FM: "narrowing differences" but cautious. But Fars (IRGC-linked) says Hormuz stays under Iranian control — Trump claims "inconsistent with reality." NYT: 1,500 ships stranded for nearly 3 months — even after deal, clearing backlog will take weeks or months (pre-war 130+ ships/day vs current ~10). Oil CRASHES on deal optimism: Brent $97.72 (-$5.82), WTI $90.83 — both at 2-week lows. Republican hawks revolt — Pompeo denounces terms. Iran FM spokesman Baqaei: "reached conclusions on many issues" but agreement "not imminent." Rubio: deal could come "today." Pakistan mediator in Beijing with Xi. Day 87.' },
  { year: 'May 14, 2026', event: 'Ship seized off UAE bound for Iran — Indian cargo ship sunk off Oman — ~30 Chinese vessels transit Hormuz — Trump-Xi summit', details: 'Ship seized by unknown parties off UAE coast near Fujairah — heading toward Iranian waters (UKMTO/AP). Indian-flagged cargo ship Haji Ali sank off Oman after attack — 14 Indian crew rescued (AP/India shipping ministry). India condemns as "unacceptable." MAJOR: ~30 Chinese vessels transit Hormuz after receiving clearance from Tehran — facilitated after requests from China\'s FM and Beijing ambassador (Iranian state media/Times Now). Transit began as Trump arrived in China. Iran selectively opening strait for preferred partners while blocking others. Trump meets Xi in Beijing — both agree Hormuz must stay open (White House/AP). Rubio: hopes to convince China to "play a more active role" (Fox News). Iran sets 5 preconditions for new talks including Hormuz sovereignty (AP/CBS). Oil: Brent ~$106-108. Day 76.' },
  { year: 'May 13, 2026', event: 'Australia joins Hormuz coalition — IEA: supply to fall below demand — Pentagon considers "Sledgehammer"', details: 'Australia announces it will join UK-France-led "strictly defensive" mission to secure Hormuz shipping (The Hindu). Growing multinational coalition forming separately from US blockade. IEA May report: global oil demand to contract by 420,000 bbl/day in 2026 — supply to fall below demand — 1.3M bbl/day less than Feb forecast. "Largest supply disruption in the history of the global oil market" (CNBCTV18/IEA). Pentagon "Sledgehammer" rebrand confirmed by NBC if ceasefire collapses. Israeli drone strikes kill 8-12 on Beirut highway ahead of May 14 Lebanon-Israel talks. Oil: Brent ~$107-108. Day 75.' },
  { year: 'May 12, 2026', event: 'Pentagon: $29B cost — ceasefire "life support" — Iran retains 30/33 Hormuz missile sites', details: 'Pentagon comptroller Jules Hurst III: war costs $29 billion (up $4B from $25B in 2 weeks — Reuters). Trump: ceasefire on "massive life support" — rejects Iran deal as "garbage" (Fox News). NBC: Pentagon considering renaming operation "Sledgehammer." BOMBSHELL: US intel — Iran regained access to 30 of 33 missile sites along Hormuz, contradicting Trump admin claims of "severely damaged" capacity (NYT/Guardian). Iraqi supertanker Agios Fanourios I transits Hormuz May 10-11 carrying crude to Vietnam (DiscoveryAlert). Oil surges: Brent $107.77 (+3.4%), WTI $102.18 (+4.2%) on ceasefire collapse fears. Day 74.' },
  { year: 'Jun 16-17, 2026', event: 'MOU SIGNED — BLOCKADE LIFTED — KHAMENEI APPROVES', details: 'US-Iran MOU officially signed by both sides. US lifts naval blockade of Iranian ports (Guardian). Iran\'s Supreme Leader Mojtaba Khamenei approves MOU "despite reservations" (Guardian). Pezeshkian signs document. Talks planned for Jun 19 at B\u00fcrgenstock resort, Switzerland. Oil continues sliding on deal momentum. The deal exists on paper — now the question is whether it survives contact with reality. Days 110-111.' },
  { year: 'Jun 18, 2026', event: 'DEADLIEST DAY — LEBANON CROSSES 4,000 DEAD', details: 'Hezbollah kills 4 Israeli soldiers near Nabatieh. Israel retaliates massively — at least 18 killed, 33 wounded in Lebanon including 2 children. Lebanon health ministry: death toll crosses 4,000 since March. Ben-Gvir: "All of Lebanon must burn." France\'s Barrot demands US pressure Israel. One of deadliest days since war began. The deal isn\'t even a week old and the killing accelerates. Day 112.' },
  { year: 'Jun 19, 2026', event: 'SWISS TALKS CANCELLED — VANCE TRIP SCRAPPED', details: 'Planned US-Iran talks at B\u00fcrgenstock resort CANCELLED due to Israel-Hezbollah violence (Guardian/CNBC/NBC). Vance\'s staff at Joint Base Andrews, dozens of officials already in Switzerland — trip scrapped. White House: "technical talks as soon as possible." Israel and Hezbollah agree renewed ceasefire after 24 hours of intense fighting (Reuters/Guardian/AP). Day 113.' },
  { year: 'Jun 25-27, 2026', event: 'HORMUZ CLASHES RESUME — IRAN DRONE HITS 2 SHIPS — US STRIKES QESHM ISLAND — 89 TRANSITS', details: 'Jun 25: Iranian drone strikes Singapore-flagged cargo ship Ever Lovely near Oman coast — ship was using US-supported route near Omani side, not Iranian-designated route. No crew injured (Al Jazeera/AP). Trump calls it "foolish violation" of MOU. Jun 26: US F-35s/F-16s strike 4 targets on Qeshm Island and Hormuz corridor — missile/drone storage and coastal radar (NYT/CENTCOM). Jun 27: Iranian drone hits Panama-flagged tanker M/T Kiku carrying 2M+ barrels of Qatari crude near Hormuz at 4:30 AM (CENTCOM/NPR/AP). US responds with strikes on Iranian surveillance, comms, air defense, drone storage, and minelayer capabilities. Trump: Iran may "no longer exist." Iran retaliates on Kuwait/Bahrain — no US casualties. UK Maritime Centre reports separate attack on vessel near Oman. Iran FM Araghchi warns any attempt to bypass Iranian-controlled routes will "increase tensions" and "delay reopening." Multinational maritime body: 89 US-assisted commercial transits through Hormuz — below historical 138/day average but "continued uninterrupted." Both sides announce stand-down Jun 28 — talks resume Tuesday. Oil: Brent ~$73/bbl — well below $119 war peak. The Hormuz corridor is functioning but contested — Iran insists ships use its routes, the US supports the Omani corridor, and both sides are striking over who controls the waterway. Days 119-123.' },
  { year: 'Jul 5-8, 2026', event: 'CEASEFIRE SHATTERS — IRAN ATTACKS 3 SHIPS — CENTCOM LAUNCHES 80+ RETALIATORY STRIKES — KHARG ISLAND HIT', details: 'Jul 5-6: Iran attacks three commercial vessels in the Strait of Hormuz during the Khamenei funeral period Trump had designated as a diplomatic pause (Hormuz Strait Monitor/International Crisis Group). The attacks mark the most aggressive Iranian naval action since the MOU was signed. Jul 7: IRGC fires missiles at ships near Hormuz (WSJ). CENTCOM responds with 80+ retaliatory strikes — hitting Kharg Island (Iran\'s primary oil export hub), drone storage, missile sites, and coastal radar installations. CENTCOM announces 20+ US Navy warships operating "across the Middle East" (Middle East Eye). Trump declares the MOU truce "over" (Truth Social). The cycle of attack and retaliation has fully resumed. The MOU\'s promise of "immediate and permanent" halt to hostilities lasted less than 3 weeks. Days 129-132.' },
  { year: 'Jul 9-11, 2026', event: 'IRAN DECLARES HORMUZ CLOSED AGAIN — US STRIKES 90+ TARGETS — SHIP ATTACKED — CREW MISSING', details: 'Jul 9: US strikes ~90 Iranian military targets including missile/drone storage and logistics sites along Iran\'s southern coast (Al Jazeera/CENTCOM). Iran retaliates with drone and missile attacks on US installations in Jordan, Bahrain, Kuwait, Qatar, and Oman. Jul 11: Iran fires on commercial vessel in Hormuz and declares the waterway closed to all traffic (CNN). M/V GFS Galaxy (Cyprus-registered) attacked — crew member reported missing. US launches retaliatory strikes. CENTCOM insists strait "remains open" and "traffic is flowing." 6,000 seafarers remain stranded according to UN estimates. Iran calls it a sovereignty issue — the Strait falls within Iranian territorial waters. Both sides have now struck each other 4 times in 1 week. Oil rebounds to ~$79/bbl. Days 133-135.' },
  { year: 'Jul 12-13, 2026', event: 'LARGEST STRIKE SINCE CEASEFIRE — 140 TARGETS — WEAPON STOCKS DEPLETED — OIL JUMPS', details: 'Jul 12: CENTCOM strikes roughly 140 Iranian military targets — the most intense US bombardment since the MOU was signed — including drone, missile, ammunition, surveillance, and naval operations sites across Iran\'s southern coast (Al Jazeera/CENTCOM). Explosions reported in Sirik, Qeshm Island, Jask, and west of Bandar Abbas. Trump authorizes: "The Commander in Chief has directed the strikes." CNN reports US weapon stocks remain "depleted" from Epic Fury — rebuilding will take 3-8 YEARS (Lockheed Martin $35.3B contract). Iran responds with counterattacks on US installations across 5 countries. Iran says Hormuz closed; CENTCOM says it remains open. Jul 13: NYT reports US hit dozens more targets — Iran fires drones at US bases. Oil jumps to Brent $78.85/bbl (+3.74%). Days 136-137.' },
  { year: 'Jul 17-19, 2026', event: '4 US TROOPS KILLED — DARKHOVIN NUCLEAR PLANT HIT — ISRAEL-HEZBOLLAH CEASEFIRE AGREED', details: 'Jul 17: 2 US service members killed at Muwaffaq Salti Air Base, Jordan. 1 missing. Jul 18: 1 more killed in Iraq. US toll: 17+ KIA. Strikes expand to Tabriz (northwest Iran). Darkhovin nuclear plant hit Jul 19. Israel-Hezbollah ceasefire agreed Jul 19 but Hezbollah subsequently rejects it. Pentagon removed 4 deaths from official count — actual toll: 20+ KIA. Days 141-143.' },
  { year: 'Jul 20, 2026', event: 'HOUTHIS BLOCKADE SAUDI ARABIA — NEW FRONT OPENS', details: 'Houthis impose maritime blockade on Saudi Arabia, attacking Saudi oil tankers in the Red Sea and threatening Bab el-Mandeb strait. This opens a new front beyond Hormuz, threatening TWO of the world\'s critical maritime chokepoints simultaneously. Combined with the collapsed MOU and renewed US-Iran strikes, the global energy crisis deepens dramatically. Day 143.' },
  { year: 'Jul 21, 2026', event: 'PENTAGON: $37.5B DIRECT MILITARY COST — HEGSETH TESTIFIES', details: 'Defense Secretary Hegseth tells Congress the war has cost $37.5 billion in direct military spending. Independent estimate: $113 billion total (iran-cost-ticker.com). Pentagon supplemental request: $87.6B. Weapons stocks "depleted" — rebuilding takes 3-8 years. THAAD interceptors depleted ~40%. 1,000+ Tomahawks used. 42 US aircraft lost/damaged. Day 144.' },
  { year: 'Jul 23, 2026', event: 'OIL BACK ABOVE $100/BBL — HOUTHI BLOCKADE BITES', details: 'Brent crude surges back above $100/barrel for first time since early June — driven by Houthi blockade of Saudi Arabia, renewed Hormuz tensions, and Hezbollah\'s rejection of the Jul 19 ceasefire. Was $83 after MOU signed Jun 19. Hormuz down to ~10 transits/day vs pre-war 90-100+. The combination of Hormuz disruption and Houthi Red Sea blockade threatens ~35% of global seaborne oil trade simultaneously. Day 146.' },
  { year: 'Jul 25, 2026', event: 'US PAUSES STRIKES — FIRST NIGHT WITHOUT STRIKES IN 14 DAYS', details: 'US did NOT strike Iran overnight — first night without US strikes since Jul 11 (14 consecutive nights). Trump advisers reportedly warned military running out of viable targets and raised concerns about depleting US weapons stockpiles. Saudi Arabia strikes Houthi targets in Hodeida, Yemen. Ukraine strikes Iranian vessels in Caspian Sea — 1 Iranian sailor killed. War reaches Caspian — new front. Hormuz traffic remains at 3-week low but no new attacks reported. Day 149.' },
  { year: 'Jul 26-27, 2026', event: 'MUTUAL PAUSE — OIL CRASHES TO $89 — HORMUZ TALKS PROGRESS', details: 'US pauses strikes for 2nd consecutive day; Iran reciprocates — "attack for attack: if the attacks stop, Iran will also halt" (senior Iranian official via Reuters). UN Ambassador Waltz: Trump "giving talks some space." Oman and Iran engaged "at every level" on Hormuz compromise. OIL CRASHES: Brent crude plunges from $100+ to ~$89-90/bbl — down 8%+, biggest single-day drop since war began. HORMUZ: Commercial shipping at 3-week low but NO ATTACKS confirmed in 72 hours (US Navy maritime body). Iran says talks with Oman on Hormuz passage "made progress." Compromise being negotiated: Iran manages Hormuz transit with fewer restrictions (regional official via AP). Netanyahu plans US visit to meet Trump. Pentagon RESTORES 4 deaths to casualty database, discloses 140+ additional wounded. Day 150 — for the first time in two weeks, nobody is shooting at Hormuz. The question is whether it lasts.' },
  { year: 'Jul 28, 2026', event: 'IRAN FIRES AT 3 TANKERS — CENTCOM: 30 REROUTED, 2 DISABLED, 2 BOARDED', details: 'Iran fires at 3 commercial tankers in Hormuz northern corridor. CENTCOM blockade update: 30 vessels rerouted, 2 disabled, 2 boarded. Only 29 transits verified Jul 24-26 (normally 100/day). Ships held in northern corridor — passage only with Iran\'s permission. Oil crashes to $81/bbl on deal talk hopes. Trump cancels "biggest attack since WWII." Oman channel active. Day 152.' },
  { year: 'Aug 1-3, 2026', event: 'DEAL TALKS INTENSIFY — OIL AT $81 — 4 NIGHTS WITHOUT STRIKES', details: 'Mutual pause extends to 4 nights without strikes. Trump cancels planned massive attack. Oman mediating actively. Oil crashes to $81/bbl — down 7.3% from $87.93 Jul 31. 22 US KIA, 624 wounded. Hormuz: 29 transits in 3 days vs normally 100/day. CENTCOM: 30 vessels rerouted. No deal signed but talks progressing. Day 157.' },
  { year: 'Jun 20, 2026', event: 'IRAN RE-CLOSES HORMUZ — CITES ISRAELI LEBANON STRIKES', details: 'Iran announces Strait of Hormuz CLOSED AGAIN — citing Israeli strikes in Lebanon as violation of MOU ceasefire terms (CNBC/NBC). IRGC: closure response to "continued ceasefire violations." US Central Command disputes closure. Shipping stalls — 0 vessels transiting (Windward/CNBC). Despite Hormuz tensions, Vance lands in Switzerland and talks begin. The deal\'s centerpiece — Hormuz reopening — is already unraveling. Iran is using Israel\'s Lebanon operations to justify re-closing the world\'s most important oil chokepoint. Day 114.' },
  { year: 'Jun 21-22, 2026', event: 'VANCE TALKS CONCLUDE — "ROAD MAP" AGREED — HORMUZ DEMINING COORDINATION', details: 'First round of high-level US-Iran negotiations concludes at B\u00fcrgenstock. Quadrilateral meeting: US (Vance), Iran (Qalibaf/Araghchi), Pakistan (PM Sharif, Army Chief Munir), Qatar. IAEA chief Grossi present. "Road map" agreed for final deal within 60 days. Vance: "a lot of good progress" on Hormuz — coordination mechanism for demining agreed. De-confliction cell for Lebanon created. Iran invites IAEA inspectors back. Araghchi: "major progress" — oil exports waived, blockade lifted, some frozen assets released. BUT: Trump threatened to "hit Iran very hard again" during talks. Hormuz: 0 vessels Jun 21, 7-day avg 2.6 vessels — 3% of pre-war traffic. Oil: WTI $77.54/bbl. The Hormuz crisis may finally have a diplomatic pathway — but zero ships are transiting and the coordination mechanism for demining has yet to begin. Days 115-116.' },
  { year: 'Jun 14-15, 2026', event: '✅ PEACE DEAL — HORMUZ BLOCKADE LIFTED — OIL CRASHES TO $83', details: 'DEAL REACHED: Pakistan PM Sharif announces US-Iran peace deal — "immediate and permanent termination of military operations on all fronts" (CBS/NBC/AP). Trump on Truth Social: "I hereby fully authorize the toll free opening of the Strait of Hormuz... Ships of the World, start your engines. Let the oil flow!" 14-point MOU includes Hormuz reopening within 30 days, mine removal, and end of US naval blockade. Signing ceremony Jun 19 in Switzerland. Oil CRASHES: Brent falls to ~$83/bbl — 3-month low — still up 20%+ since war began (Guardian/TradingEconomics/Fortune). WTI drops to $80. UK Commons Library analysis: shipping levels through Hormuz "remain low" despite conditional ceasefire — full reopening will take weeks. EU chief Costa: "I look forward to the full restoration of freedom of navigation in the Strait of Hormuz." Macron urges "resumption of maritime traffic, without restriction or toll." BUT: Israel bombed Beirut hours before the deal, and Netanyahu says Israel won\'t withdraw from Lebanon. The 108-day Hormuz crisis — the most devastating disruption to global energy markets since 1973 — may finally be ending. But the strait won\'t fully reopen until mines are cleared and trust rebuilt. Day 108-109.' },
  { year: 'Jun 9-10, 2026', event: 'Apache downed — US-Iran exchange strikes near Hormuz — secret escort mission revealed', details: 'US Apache helicopter downed near Strait of Hormuz — Trump blames Iran (NPR/Truth Social). CENTCOM launches "self-defense strikes" on Iranian air defense, ground control, and radar sites near Hormuz (CENTCOM/CNBC/AP). Iran retaliates: IRGC attacks Bahrain 5th Fleet and Ali Al-Salem in Kuwait. Second day of strikes "more intense and wider" (NPR). Trump reveals US military executed "secret mission" to help move 100 MILLION barrels of oil through Hormuz — more than 200 commercial ships traversed the waterway (CNN). US fires missiles to disable tanker attempting to transport Iranian oil. Iran fires back at Kuwait, Bahrain, Jordan. Guardian: "Is the Iran ceasefire over?" The strait remained the flashpoint even as deal talks continued. Days 102-103.' },
  { year: 'May 11, 2026', event: 'Iran: US has "unreasonable demands" — oil surges — no talks scheduled', details: 'Iran FM spokesman: US has "unreasonable demands" — Iran\'s response "was not excessive" (CBS/Al Jazeera). Iran demands: end to war, lift blockade, release frozen assets. Oil surges: Brent ~$104 (+2.5%), WTI ~$98 (+2%) on failed talks (CNBC). UNDP: $299B economic losses to Asia-Pacific — 8.8M at risk of poverty. Asia braces for "second wave" of energy shocks as first defenses running out (CBS/Brookings). 20 warships enforce blockade. No new Hormuz transits reported. No talks scheduled. Trump visiting China this week — pressure to resolve. Day 73.' },
  { year: 'May 8, 2026', event: 'US fires on 3 Iranian tankers — Iran seizes Ocean Koi — 3 destroyers attacked — CIA: Iran can last months', details: 'US F/A-18 fires precision munitions into smokestacks of 2 Iranian oil tankers (Sea Star III, Sevda) to stop them docking at Iranian port — also disabled M/T Hasna by firing into its rudder (CENTCOM). Iran seizes oil tanker Ocean Koi in Sea of Oman. 3 US destroyers (Truxtun, Rafael Peralta, Mason) attacked by Iranian missiles/drones/small boats May 7 — none struck. US retaliates on Bandar Abbas and Qeshm Island. CIA assessment: Iran can withstand blockade until later this year, retains ~70% of ballistic missiles (WaPo). CENTCOM: 70+ tankers blocked from Iranian ports — 166M barrel capacity worth $13B+. Trump calls strikes "just a love tap." Brent $101.29. Day 70.' },
  { year: 'May 5, 2026', event: 'Project Freedom — USS Truxtun/Mason transit Hormuz under fire — 20,000 seafarers stranded', details: 'USS Truxtun and USS Mason transit Strait of Hormuz and enter Persian Gulf under sustained Iranian barrage — neither struck (CBS). Maersk Alliance Fairfax transits under escort. IMO: 20,000 seafarers stranded on 2,000 vessels. UAE air defenses engage Iranian missiles/drones for 2nd consecutive day. Araghchi heads to Beijing. Oil $113/bbl. Day 67.' },
  { year: 'May 4, 2026', event: 'Project Freedom launches — Iran fires at UAE — ceasefire fractures', details: 'Trump\'s "Project Freedom" begins — 2 US-flagged commercial vessels transit Hormuz under destroyer escort. Iran fires 4 cruise missiles at UAE — first attack since ceasefire (3 intercepted). ADNOC tanker targeted with drones in Hormuz. Iran denies any ships transited. Hezbollah leader rejects ceasefire entirely. Day 66.' },
  { year: 'Apr 27, 2026', event: 'Iran offers Hormuz-for-peace — UN rejects tolls — Araghchi meets Putin — Only 5 ships in 24h', details: 'Iran proposes to reopen Hormuz if US lifts blockade and ends war — nuclear program discussions postponed to later date (AP, 2 regional officials). Proposal passed to US by Pakistan. Trump unlikely to accept — wants nuclear resolved in deal. Trump: "We have all the cards." Araghchi meets Putin in St. Petersburg — Russia pledges "everything possible" for peace. Araghchi blames US "excessive demands" for Pakistan talks failure. UN IMO Secretary-General Dominguez: "no legal basis" for imposing tolls or fees on strait transit — directly rejects Iran\'s toll-booth proposal. Iran armed forces would control Hormuz under proposed Iranian law. Germany\'s Merz: US had "no strategy." UK\'s Doughty: UK doesn\'t support US blockade but supports Hormuz reopening. Only 5 ships through Hormuz in 24 hours (Reuters). 3 US carriers deployed. Brent ~$108/barrel. Chevron CEO Wirth: impacts "will be with us for some time." The biggest Iranian concession yet — but Trump wants everything. Day 59.' },
]
...
const consumerImpact = [
  ...
  { item: 'Diesel/Trucking', current: '$5.98/gallon record (Sep 10)', projected: '$6.50–7.50/gallon', timeline: 'Within 1-2 weeks', mechanism: 'Diesel tracks crude more directly. Every product shipped by truck gets more expensive.' },
