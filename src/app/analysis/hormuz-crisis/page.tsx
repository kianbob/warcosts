...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Day 57: Araghchi meets Pakistan PM, lays out demands, denies direct US talks. Tehran flights resume. CENTCOM: 34 ships turned back. 3 carrier strike groups deployed. Oil ~$105. Ghalibaf: Hormuz stays closed while blockade remains. IEA: biggest energy crisis in history.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
