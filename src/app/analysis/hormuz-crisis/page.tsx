...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Day 53: CEASEFIRE EXPIRES — Trump won\'t extend. Navy SEALs seize MT Tifani oil tanker (~2M barrels). Xi Jinping demands Hormuz reopened (first time). IEA: biggest energy crisis in history. France: war costing €4-6B. Hormuz still closed. CENTCOM: 28 ships turned back under blockade. Oil ~$95.75/bbl.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
