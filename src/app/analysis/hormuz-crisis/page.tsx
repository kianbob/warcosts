...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Iran controls it. Day 39: Trump issues strict Tuesday deadline — threatens "complete demolition" of power plants/bridges. 3rd Turkish ship transits. Iran rejects ceasefire, issues 10-point counterproposal. King Fahd Causeway closed. Oil ~$110/bbl. South Korea sends 5 ships to Saudi port Yanbu. Iran maintains selective blockade 39 days in.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
...
const historicalThreats = [
  ...
  { year: 'Apr 7, 2026', event: 'Trump\'s Tuesday deadline — "complete demolition" threat', details: 'Trump issues his most specific and aggressive deadline yet: threatens the "complete demolition" of Iran\'s power plants and bridges if Tehran does not fully reopen Hormuz by 8pm Washington time Tuesday (00:00 GMT Wednesday). International law experts say targeting civilian power infrastructure constitutes a war crime. Iran\'s military dismisses the threats as "delusional," saying they cannot mask US "disgrace and humiliation." Israel strikes Kharg Island oil hub again — if confirmed, a major escalation targeting Iran\'s primary oil export chokepoint. Israel also hits Iran\'s largest petrochemical complex serving South Pars and two electricity units powering the gasfield. Iran calls these strikes targeting the "survival capabilities" of the Iranian people. Xi Jinping calls for accelerated new energy systems. Brent ~$110/barrel. The question is no longer whether Trump will follow through on his deadline — it\'s how far he\'ll go when Iran inevitably ignores it. Day 39.' },
]
