...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Day 51: Iran RE-CLOSES Hormuz after US refuses to lift naval blockade. IRGC gunboats fire on tanker. Oil rebounds to ~$90-95/bbl. Vance heading to Pakistan but Iran refuses to send delegation. Trump threatens every bridge and power plant. Ceasefire expires Apr 21 — 2 days left.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-stone-800 rounded-lg p-6 my-6">
        ...
        <p className="text-stone-300 text-sm mt-4">
          <strong>Current status (as of Apr 19, 2026 — Day 51):</strong> Iran RE-CLOSED Hormuz on Apr 18 after brief 24-hour opening. IRGC gunboats fired on tanker. Ships reversing course, hundreds waiting. US naval blockade of Iranian ports continues. Oil ~$90-95/bbl. 
