...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Day 56: Hegseth says blockade "growing and going global." 3rd carrier arrives. CENTCOM: 34 ships turned back. 2 dark fleet ships seized in Indo-Pacific. Lebanon ceasefire extended 3 weeks. Iran FM heading to Islamabad. Pentagon threatens NATO allies. US munitions depleted. Oil ~$107. Ghalibaf: Hormuz stays closed while blockade remains.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
