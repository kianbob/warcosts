...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Iran controls it. Day 40: CEASEFIRE — Iran agrees to reopen Hormuz. Oil crashes 15%. Pakistan-mediated talks begin Apr 10 in Islamabad. 2-week pause conditional on Hormuz reopening. 5,000+ killed across region in 39 days.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
...
const historicalThreats = [
  ...
  { year: 'Apr 8, 2026', event: 'CEASEFIRE — Oil crashes 15% — Hormuz reopening begins', details: 'Oil plunges 15%+ on ceasefire news (US crude futures). S&P 500 futures jump 2.2%. The ceasefire is CONDITIONAL on Iran reopening the Strait of Hormuz — the first concrete mechanism for ending the 40-day blockade. Iran agreed to allow "safe passage" via coordination with its Armed Forces during the 2-week pause. Pakistan-mediated talks in Islamabad starting April 10 will address a permanent Hormuz framework as part of Iran\'s 10-point counterproposal. After 40 days, the world\'s most important chokepoint may finally begin reopening — but whether Iran fully complies, and whether the ceasefire holds, remains deeply uncertain. IAEA warned strikes near Bushehr "could cause severe radiological accident." 5,000+ killed across region (Reuters). Day 40.' },
]
