...
export const metadata: Metadata = {
  ...
  description: '20% of global oil flows through a 21-mile strait. Day 54: Trump extends ceasefire indefinitely but blockade remains. Iran calls blockade "act of war," seizes 2 ships in Hormuz. CENTCOM: 29 ships turned back. Graham: blockade "could become global soon." US intel: Iran retains ~50% missiles, ~60% navy. Iran threatens Gulf oil production. MT Tifani boarding first US seizure outside Middle East.',
  openGraph: {
    title: 'The Strait of Hormuz: How One Waterway Could Crash the Global Economy',
