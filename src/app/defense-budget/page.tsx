...
export const metadata: Metadata = {
  title: 'US Defense Budget Breakdown — $886B in FY2024',
  description: 'Where every dollar of the $886B defense budget goes. Service branches, black budget, nuclear weapons, intelligence ($90B+), and total cost ($1.4T+).',
