    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 gap-4 my-8">
        <div className="bg-white border border-stone-200 rounded-lg p-6">
          ...
          <p className="text-3xl font-bold text-stone-900 font-[family-name:var(--font-heading)]">{vote.houseVote}</p>
          {house && (
            <div className="mt-3">
        ...
        <div className="bg-white border border-stone-200 rounded-lg p-6">
          ...
          <p className="text-3xl font-bold text-stone-900 font-[family-name:var(--font-heading)]">{vote.senateVote}</p>
          {senate && (
            <div className="mt-3">
              <div className="flex gap-1 h-4 rounded-full overflow-hidden">
