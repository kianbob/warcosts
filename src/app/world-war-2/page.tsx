...
const timeline = [
  ...
  { year: 'Dec 1944', title: 'Battle of the Bulge', desc: 'Germany\'s last major offensive catches the Allies off guard in the Ardennes. 19,000 Americans killed, 47,500 wounded in 6 weeks — the bloodiest battle in US history. The offensive fails, and the German army has spent its last reserves.' },
