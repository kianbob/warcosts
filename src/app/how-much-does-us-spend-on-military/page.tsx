    ...
    <div className="bg-stone-900 min-h-screen text-stone-300 -mt-4 -mx-4 px-4 pt-4">
      <div className="max-w-5xl mx-auto py-8">
        ...
        <p className="text-lg text-stone-300 max-w-3xl mb-4">
          In 2024, the United States spent <strong className="text-red-400">$968 billion</strong> on its military — according to
          ...
          spends roughly <strong className="text-red-400">$30,700</strong>.
        </p>
        ...
        <div className="bg-stone-800 border border-red-600/30 rounded-xl p-6 my-8">
          ...
          <p className="text-stone-300">
            The US spent <strong className="text-red-400">$968 billion</strong> on defense in 2024 (SIPRI estimate including
            ...
            the true national security budget exceeds <strong className="text-red-400">$1.4 trillion</strong> — roughly{' '}
        ...
        <div className="overflow-x-auto mb-8">
          <table className="w-full text-sm border border-stone-700 rounded-lg overflow-hidden">
            <thead className="bg-stone-800">
              <tr>
                <th className="text-left p-3 text-stone-400 font-[family-name:var(--font-heading)]">Year</th>
                <th className="text-right p-3 text-stone-400 font-[family-name:var(--font-heading)]">Amount (2024$)</th>
                <th className="text-left p-3 text-stone-400 font-[family-name:var(--font-heading)]">President</th>
                <th className="text-left p-3 text-stone-400 font-[family-name:var(--font-heading)]">Context</th>
              </tr>
            </thead>
            <tbody>
              {recent.map((s) => (
                <tr key={s.year} className="border-t border-stone-700/50">
                  <td className="p-3 font-medium text-white">{s.year}</td>
                  <td className="p-3 text-red-400 font-semibold text-right">{fmtMoney(s.amountBillions * 1e9)}</td>
                  <td className="p-3 text-stone-400">{s.president}</td>
            ...
            return (
              <div key={c.country}>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="font-medium text-stone-300">{fmtMoney(c.amount)} · {c.pctWorld}% of world</span>
                </div>
          ...
          {budgetBreakdown.map((b) => (
            <div key={b.label}>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="font-medium text-red-400">{fmtMoney(b.amount)} ({b.pct}%)</span>
              </div>
              <div className="h-4 bg-stone-700 rounded-full overflow-hidden">
        ...
        <div className="bg-stone-800 border border-stone-700 rounded-xl p-6 my-8">
          ...
          <ul className="space-y-3 text-stone-300">
            ...
            <li>• The Pentagon has <strong className="text-red-400">never passed a financial audit</strong> despite being required by law since 1990</li>
          </ul>
        </div>
        ...
        <div className="space-y-6 mb-8">
          <div className="bg-stone-800 rounded-lg p-5 border border-stone-700">
            ...
            <p className="text-stone-300 text-sm">
              ...
              led by contractors like <Link href="/contractors" className="text-red-400 hover:underline">Lockheed Martin,
          ...
          <div className="bg-stone-800 rounded-lg p-5 border border-stone-700">
            ...
            <p className="text-stone-300 text-sm">
              ...
              figure exceeds <strong className="text-red-400">$1.4 trillion per year</strong>. See our full{' '}
              <Link href="/spending/2024" className="text-red-400 hover:underline">2024 spending breakdown</Link>.
            </p>
          </div>
        </div>
        ...
        <div className="bg-stone-800 rounded-lg p-6 border border-stone-700 mt-12">
          ...
          <ul className="space-y-2">
            <li><Link href="/spending" className="text-red-400 hover:underline">→ Historical Military Spending (1949–Present)</Link></li>
            <li><Link href="/spending/2024" className="text-red-400 hover:underline">→ 2024 Defense Budget Breakdown</Link></li>
            <li><Link href="/global-spending" className="text-red-400 hover:underline">→ Global Military Spending by Country</Link></li>
            <li><Link href="/contractors" className="text-red-400 hover:underline">→ Top Defense Contractors — Who Gets the Money</Link></li>
            <li><Link href="/opportunity-cost" className="text-red-400 hover:underline">→ What $968 Billion Could Buy Instead</Link></li>
          </ul>
        </div>
