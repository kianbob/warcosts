...
const navItems = [
  ...
  { label: '🗺️ War Map', href: '/war-map' },
  {
    ...
    items: [
      ...
      { label: 'Who Fights Our Wars?', href: '/who-fights' },
      { label: 'Blowback Map', href: '/blowback-map' },
      { label: 'Presidents at War', href: '/presidents' },
      { label: 'Countries', href: '/countries' },
      { label: 'Decades', href: '/decades' },
      { label: '── Learn More ──', href: '/explore#more' },
      { label: 'Congress & War', href: '/congress-and-war' },
      { label: 'War Calendar', href: '/war-calendar' },
      { label: 'War Propaganda', href: '/war-propaganda' },
      { label: 'War Powers', href: '/war-powers' },
    ],
  },
  {
    label: 'Money',
    items: [
      ...
      { label: 'War Profiteers', href: '/war-profiteers' },
      { label: 'Weapons Exposed', href: '/weapons-exposed' },
      { label: 'The $32T Receipt', href: '/the-receipt' },
      { label: '── Data Deep Dives ──', href: '/spending#data' },
      { label: 'Pentagon Audit Tracker', href: '/pentagon-audit' },
      { label: 'Cost Overruns Database', href: '/cost-overruns' },
      { label: 'War ROI Rankings', href: '/war-roi' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '── Simulators ──', href: '/tools#simulators' },
      { label: 'Budget Simulator', href: '/tools/budget-simulator' },
      { label: 'Draft Simulator', href: '/tools/draft-simulator' },
      { label: 'Inflation Calculator', href: '/tools/inflation-calculator' },
      { label: 'War Quiz', href: '/tools/war-quiz-hard' },
      { label: '── Analysis Tools ──', href: '/tools#analysis' },
      { label: 'State Impact', href: '/tools/state-impact' },
      { label: 'Compare Wars', href: '/tools/compare-wars' },
      { label: 'Casualty Calculator', href: '/tools/casualty-calculator' },
      { label: 'Timeline Explorer', href: '/tools/timeline-explorer' },
      { label: 'Hormuz Calculator', href: '/tools/hormuz-calculator' },
      { label: 'Iran vs Iraq', href: '/tools/iran-vs-iraq' },
    ],
  },
  {
    label: 'Empire',
    items: [
      ...
      { label: '── Expansion ──', href: '/empire#expansion' },
      { label: 'Iran Destruction', href: '/iran-destruction' },
      { label: 'Private War', href: '/private-war' },
      { label: 'Allied Costs', href: '/allied-costs' },
    ],
  },
  {
    label: 'Analysis',
    items: [
      ...
      { label: '── Iran War 2026 ──', href: '/analysis#iran' },
      { label: 'Iran 2026: Full Coverage', href: '/analysis/iran-2026' },
      { label: 'The $28,095-Per-Second War', href: '/analysis/iran-cost-per-second' },
      { label: 'The Civilian Cost', href: '/analysis/iran-civilian-cost' },
      { label: '11 Countries, 7 Days', href: '/analysis/iran-regional-war' },
      { label: 'Russia\'s Shadow War', href: '/analysis/iran-russia-shadow-war' },
      { label: 'Hormuz: The $80B Chokepoint', href: '/analysis/hormuz-crisis' },
      { label: 'Day by Day', href: '/iran-war-day-by-day' },
      { label: 'Casualties Tracker', href: '/analysis/iran-war-casualties' },
      { label: 'No Authorization', href: '/analysis/iran-war-no-authorization' },
      { label: 'World Impact', href: '/analysis/iran-war-world-impact' },
      { label: 'Lebanon Burns', href: '/analysis/lebanon-war-2026' },
      { label: 'Oil Price Shock', href: '/analysis/oil-price-shock-2026' },
      { label: '── Perspectives ──', href: '/analysis#perspectives' },
      { label: "Veterans' Voices", href: '/veterans-voices' },
      { label: 'The Other Side', href: '/the-other-side' },
      { label: 'Global Reactions', href: '/global-reactions' },
