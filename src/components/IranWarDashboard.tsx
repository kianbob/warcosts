...
export default function IranWarDashboard() {
  ...
  const totalCost = 130_000_000_000 // Updated: $43.6B direct military (CENTCOM Sep 3), $130B+ total economic through Sep 2026
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 my-6">
      <StatCard label="War Duration" value="206 Days" sub="Feb 28, 2026 – ongoing. War cost $43.6B. Trump: gas prices inexpensive. Iran strikes tankers. Israel enters Syria." />
      <StatCard label="Total Cost" value="$130B+ total" sub="$43.6B direct military (CENTCOM Sep 3) | $100B+ consumer energy cost (Axios/Brown)" />
      ...
      <StatCard label="US Troops" value="18 KIA" sub="830+ wounded (DCAS Sep 18). 42 aircraft lost. THAAD depleted ~40%." />
      <StatCard label="Oil Impact" value="$103/bbl" sub="Brent crude. Gas $4.48/gal (+$1.27 YoY). Hormuz: ~6-10 ships/day vs 85 normal." />
