...
export default function Footer() {
  return (
    <footer className="bg-stone-900 text-stone-400 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-8 text-sm">
        {/* Explore */}
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/iran-war-day-by-day" className="hover:text-white">Day-by-Day</Link></li>
            ...
            <li><Link href="/iran-destruction" className="hover:text-white">Destruction</Link></li>
            <li><Link href="/global-reactions" className="hover:text-white">Global Reactions</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/war-profiteers" className="hover:text-white">War Profiteers</Link></li>
            <li><Link href="/cost-per-kill" className="hover:text-white">Cost Per Kill</Link></li>
            <li><Link href="/the-receipt" className="hover:text-white">The Receipt</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/tools/budget-simulator" className="hover:text-white">Budget Simulator</Link></li>
            <li><Link href="/tools/draft-simulator" className="hover:text-white">Draft Simulator</Link></li>
            <li><Link href="/tools/inflation-calculator" className="hover:text-white">Inflation Calculator</Link></li>
            <li><Link href="/tools/war-quiz-hard" className="hover:text-white">War Quiz</Link></li>
            <li><Link href="/tools/state-impact" className="hover:text-white">State Impact</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/weapons-exposed" className="hover:text-white">Weapons Exposed</Link></li>
            <li><Link href="/war-calendar" className="hover:text-white">War Calendar</Link></li>
        ...
        {/* Perspectives */}
        <div>
          <h3 className="text-white font-semibold mb-3 text-sm uppercase tracking-wider">Perspectives</h3>
          <ul className="space-y-2">
            <li><Link href="/veterans-voices" className="hover:text-white">Veterans&rsquo; Voices</Link></li>
            <li><Link href="/the-other-side" className="hover:text-white">The Other Side</Link></li>
            <li><Link href="/allied-costs" className="hover:text-white">Allied Costs</Link></li>
            <li><Link href="/private-war" className="hover:text-white">Contractors&rsquo; War</Link></li>
            <li><Link href="/media-coverage" className="hover:text-white">Media Coverage</Link></li>
            <li><Link href="/military-families-impact" className="hover:text-white">Military Families</Link></li>
          </ul>
        </div>
